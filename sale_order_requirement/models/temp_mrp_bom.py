...
class temp_mrp_bom(orm.Model):
    ...
    _columns = {
        ...
        # 'routing_id': fields.function(_get_routing, method=True, type='integer', string='Routing', readonly=True),
        'routing_id': fields.many2one('mrp.routing', string='Routing', auto_join=True),
