...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:template name="first_page_graphics_corporation">
		...
		<fill color="black"/>
        <stroke color="black"/>
        <setFont name="DejaVu Sans Bold" size="9"/>
        <drawString x="1.3cm" y="28.3cm"><xsl:value-of select="//reportname"/></drawString>
        <drawString x="7.6cm" y="28.3cm"><xsl:value-of select="//company"/></drawString>
        <setFont name="DejaVu Sans" size="8"/>
        <drawString x="15.5cm" y="28.3cm"><xsl:value-of select="//date"/></drawString>
        <stroke color="#000000"/>
	...
	<xsl:template name="other_pages_graphics_corporation">
        ...
        <stroke color="black"/>
        <setFont name="DejaVu Sans" size="8"/>
        <drawString x="15.0cm" y="28.3cm"><xsl:value-of select="//date"/></drawString>
        <setFont name="DejaVu Sans Bold" size="9"/>
        <drawString x="1.3cm" y="28.3cm"><xsl:value-of select="//reportname"/></drawString>
        <drawString x="7.5cm" y="28.3cm"><xsl:value-of select="//company"/></drawString>
        <stroke color="#000000"/>
        <lines>1.3cm 28.1cm 20cm 28.1cm</lines>
 	</xsl:template>
