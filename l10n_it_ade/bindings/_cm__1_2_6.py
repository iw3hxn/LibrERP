...
class Documento_Type(pyxb.binding.basis.complexTypeDefinition):
    ...
    identificativo = property(
        __identificativo.value, __identificativo.set, None, None)
...
Documento = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(
        Namespace, 'Documento'), Documento_Type, abstract=pyxb.binding.datatypes.boolean(1), location=pyxb.utils.utility.Location('../data/common/fornitura_v3.xsd', 20, 1))
Namespace.addCategoryObject(
