# -*- coding: utf-8 -*-
# ./fatturapa_v_1_2_1__1_2_4.py
# PyXB bindings for NM:32e521a6da5b62d07147ea75b23acb0fb9726893
# Generated 2020-08-18 12:13:36.328366 by PyXB version 1.2.4 using Python 2.7.18.final.0
# by Andrei Levin <andrei.levin@didotech.com>
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:7145f4e6-e13b-11ea-8ce8-acde48001122')
...
Namespace = pyxb.namespace.NamespaceForURI('http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.2',
...
class CodiceDestinatarioType(pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 57, 2)
    _Documentation = None
...
class CodiceType(pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 68, 2)
    _Documentation = None
...
class FormatoTrasmissioneType(pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 74, 2)
    _Documentation = None


FormatoTrasmissioneType._CF_enumeration = pyxb.binding.facets.CF_enumeration(value_datatype=FormatoTrasmissioneType,
                                                                             enum_prefix=None)
FormatoTrasmissioneType.FPA12 = FormatoTrasmissioneType._CF_enumeration.addEnumeration(unicode_value='FPA12',
                                                                                       tag='FPA12')
FormatoTrasmissioneType.FPR12 = FormatoTrasmissioneType._CF_enumeration.addEnumeration(unicode_value='FPR12',
                                                                                       tag='FPR12')
...
class CausalePagamentoType(pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 163, 2)
    _Documentation = None


CausalePagamentoType._CF_enumeration = pyxb.binding.facets.CF_enumeration(value_datatype=CausalePagamentoType,
                                                                          enum_prefix=None)
...
class TipoScontoMaggiorazioneType(pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 196, 2)
    _Documentation = None
...
TipoScontoMaggiorazioneType.SC = TipoScontoMaggiorazioneType._CF_enumeration.addEnumeration(unicode_value='SC',
                                                                                            tag='SC')
TipoScontoMaggiorazioneType.MG = TipoScontoMaggiorazioneType._CF_enumeration.addEnumeration(unicode_value='MG',
                                                                                            tag='MG')
...
class Art73Type(pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 211, 2)
    _Documentation = None
...
class TipoCassaType(pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 221, 2)
    _Documentation = None
...
class TipoDocumentoType(pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 336, 2)
    _Documentation = None


TipoDocumentoType._CF_enumeration = pyxb.binding.facets.CF_enumeration(value_datatype=TipoDocumentoType,
                                                                       enum_prefix=None)
...
class TipoRitenutaType(pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 431, 2)
    _Documentation = None
...
class RiferimentoNumeroLineaType(pyxb.binding.datatypes.integer):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 482, 2)
    _Documentation = None
...
class SoggettoEmittenteType(pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 528, 2)
    _Documentation = None


SoggettoEmittenteType._CF_enumeration = pyxb.binding.facets.CF_enumeration(value_datatype=SoggettoEmittenteType,
                                                                           enum_prefix=None)
...
class RegimeFiscaleType(pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 568, 2)
    _Documentation = None


RegimeFiscaleType._CF_enumeration = pyxb.binding.facets.CF_enumeration(value_datatype=RegimeFiscaleType,
                                                                       enum_prefix=None)
...
class CondizioniPagamentoType(pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 780, 2)
    _Documentation = None


CondizioniPagamentoType._CF_maxLength = pyxb.binding.facets.CF_maxLength(
    value=pyxb.binding.datatypes.nonNegativeInteger(4))
CondizioniPagamentoType._CF_enumeration = pyxb.binding.facets.CF_enumeration(value_datatype=CondizioniPagamentoType,
                                                                             enum_prefix=None)
...
class ModalitaPagamentoType(pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 826, 2)
    _Documentation = None


ModalitaPagamentoType._CF_enumeration = pyxb.binding.facets.CF_enumeration(value_datatype=ModalitaPagamentoType,
                                                                           enum_prefix=None)
...
class IBANType(pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 946, 2)
    _Documentation = None
...
class BICType(pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 951, 2)
    _Documentation = None
...
class RitenutaType(pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1017, 2)
    _Documentation = None
...
class EsigibilitaIVAType(pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1039, 2)
    _Documentation = None


EsigibilitaIVAType._CF_maxLength = pyxb.binding.facets.CF_maxLength(value=pyxb.binding.datatypes.nonNegativeInteger(1))
EsigibilitaIVAType._CF_enumeration = pyxb.binding.facets.CF_enumeration(value_datatype=EsigibilitaIVAType,
                                                                        enum_prefix=None)
...
class NaturaType(pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1060, 2)
    _Documentation = None
...
class CodiceFiscaleType(pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1187, 2)
    _Documentation = None
...
class CodiceFiscalePFType(pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1192, 2)
    _Documentation = None
...
class CodEORIType(pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1197, 2)
    _Documentation = None
...
class SocioUnicoType(pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1203, 2)
    _Documentation = None
...
class StatoLiquidazioneType(pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1217, 2)
    _Documentation = None


StatoLiquidazioneType._CF_enumeration = pyxb.binding.facets.CF_enumeration(value_datatype=StatoLiquidazioneType,
                                                                           enum_prefix=None)
...
class TipoCessionePrestazioneType(pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1231, 2)
    _Documentation = None
...
TipoCessionePrestazioneType.SC = TipoCessionePrestazioneType._CF_enumeration.addEnumeration(unicode_value='SC',
                                                                                            tag='SC')
TipoCessionePrestazioneType.PR = TipoCessionePrestazioneType._CF_enumeration.addEnumeration(unicode_value='PR',
                                                                                            tag='PR')
TipoCessionePrestazioneType.AB = TipoCessionePrestazioneType._CF_enumeration.addEnumeration(unicode_value='AB',
                                                                                            tag='AB')
TipoCessionePrestazioneType.AC = TipoCessionePrestazioneType._CF_enumeration.addEnumeration(unicode_value='AC',
                                                                                            tag='AC')
...
class TitoloType(pyxb.binding.datatypes.normalizedString):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1256, 2)
    _Documentation = None
...
class String10Type(pyxb.binding.datatypes.normalizedString):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1262, 2)
    _Documentation = None
...
class String15Type(pyxb.binding.datatypes.normalizedString):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1267, 2)
    _Documentation = None
...
class String20Type(pyxb.binding.datatypes.normalizedString):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1272, 2)
    _Documentation = None
...
class String35Type(pyxb.binding.datatypes.normalizedString):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1277, 2)
    _Documentation = None
...
class String35LatinExtType(pyxb.binding.datatypes.normalizedString):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1282, 2)
    _Documentation = None
...
class String60Type(pyxb.binding.datatypes.normalizedString):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1288, 2)
    _Documentation = None
...
class String80Type(pyxb.binding.datatypes.normalizedString):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1293, 2)
    _Documentation = None
...
class String100Type(pyxb.binding.datatypes.normalizedString):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1298, 2)
    _Documentation = None
...
class String60LatinType(pyxb.binding.datatypes.normalizedString):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1303, 2)
    _Documentation = None
...
class String80LatinType(pyxb.binding.datatypes.normalizedString):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1308, 2)
    _Documentation = None
...
class String100LatinType(pyxb.binding.datatypes.normalizedString):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1313, 2)
    _Documentation = None
...
class String200LatinType(pyxb.binding.datatypes.normalizedString):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1318, 2)
    _Documentation = None
...
class String1000LatinType(pyxb.binding.datatypes.normalizedString):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1323, 2)
    _Documentation = None
...
class ProvinciaType(pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1328, 2)
    _Documentation = None
...
class NazioneType(pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1333, 2)
    _Documentation = None
...
class DivisaType(pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1338, 2)
    _Documentation = None
...
class TipoResaType(pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1343, 2)
    _Documentation = None
...
class NumeroCivicoType(pyxb.binding.datatypes.normalizedString):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1348, 2)
    _Documentation = None
...
class BolloVirtualeType(pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1353, 2)
    _Documentation = None


BolloVirtualeType._CF_enumeration = pyxb.binding.facets.CF_enumeration(value_datatype=BolloVirtualeType,
                                                                       enum_prefix=None)
...
class TelFaxType(pyxb.binding.datatypes.normalizedString):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1358, 2)
    _Documentation = None
...
class EmailType(pyxb.binding.datatypes.normalizedString):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1363, 2)
    _Documentation = None
...
class PesoType(pyxb.binding.datatypes.decimal):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1370, 2)
    _Documentation = None
...
class Amount8DecimalType(pyxb.binding.datatypes.decimal):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1375, 2)
    _Documentation = None
...
class Amount2DecimalType(pyxb.binding.datatypes.decimal):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1380, 2)
    _Documentation = None
...
class RateType(pyxb.binding.datatypes.decimal):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1385, 2)
    _Documentation = None
...
class RiferimentoFaseType(pyxb.binding.datatypes.integer):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1391, 2)
    _Documentation = None


RiferimentoFaseType._CF_maxInclusive = pyxb.binding.facets.CF_maxInclusive(value_datatype=RiferimentoFaseType,
                                                                           value=pyxb.binding.datatypes.integer(999))
RiferimentoFaseType._CF_minInclusive = pyxb.binding.facets.CF_minInclusive(value_datatype=RiferimentoFaseType,
...
class NumeroColliType(pyxb.binding.datatypes.integer):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1397, 2)
    _Documentation = None


NumeroColliType._CF_maxInclusive = pyxb.binding.facets.CF_maxInclusive(value_datatype=NumeroColliType,
                                                                       value=pyxb.binding.datatypes.integer(9999))
NumeroColliType._CF_minInclusive = pyxb.binding.facets.CF_minInclusive(value_datatype=NumeroColliType,
                                                                       value=pyxb.binding.datatypes.integer(1))
...
class NumeroLineaType(pyxb.binding.datatypes.integer):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1403, 2)
    _Documentation = None


NumeroLineaType._CF_maxInclusive = pyxb.binding.facets.CF_maxInclusive(value_datatype=NumeroLineaType,
                                                                       value=pyxb.binding.datatypes.integer(9999))
NumeroLineaType._CF_minInclusive = pyxb.binding.facets.CF_minInclusive(value_datatype=NumeroLineaType,
                                                                       value=pyxb.binding.datatypes.integer(1))
...
class CAPType(pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1409, 2)
    _Documentation = None
...
class ABIType(pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1414, 2)
    _Documentation = None
...
class CABType(pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1419, 2)
    _Documentation = None
...
class GiorniTerminePagamentoType(pyxb.binding.datatypes.integer):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1424, 2)
    _Documentation = None
...
class QuantitaType(pyxb.binding.datatypes.decimal):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1430, 2)
    _Documentation = None
...
class DataFatturaType(pyxb.binding.datatypes.date):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1435, 2)
    _Documentation = None


DataFatturaType._CF_minInclusive = pyxb.binding.facets.CF_minInclusive(value_datatype=DataFatturaType,
...
class FatturaElettronicaHeaderType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 25, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType

    # Element DatiTrasmissione uses Python identifier DatiTrasmissione
    __DatiTrasmissione = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'DatiTrasmissione'),
                                                                 'DatiTrasmissione',
            ...
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 27, 6), )
    ...
    __CedentePrestatore = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'CedentePrestatore'), 'CedentePrestatore',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_FatturaElettronicaHeaderType_CedentePrestatore',
        False, pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 28, 6), )
    ...
    __RappresentanteFiscale = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'RappresentanteFiscale'), 'RappresentanteFiscale',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_FatturaElettronicaHeaderType_RappresentanteFiscale',
        False, pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 29, 6), )
    ...
    __CessionarioCommittente = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'CessionarioCommittente'), 'CessionarioCommittente',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_FatturaElettronicaHeaderType_CessionarioCommittente',
        False, pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 30, 6), )
    ...
    __TerzoIntermediarioOSoggettoEmittente = pyxb.binding.content.ElementDeclaration(
        ...
        False, pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 31, 6), )

    TerzoIntermediarioOSoggettoEmittente = property(__TerzoIntermediarioOSoggettoEmittente.value,
                                                    __TerzoIntermediarioOSoggettoEmittente.set, None, None)
    ...
    __SoggettoEmittente = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'SoggettoEmittente'), 'SoggettoEmittente',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_FatturaElettronicaHeaderType_SoggettoEmittente',
        False, pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 32, 6), )
...
class FatturaElettronicaBodyType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 35, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType

    # Element DatiGenerali uses Python identifier DatiGenerali
    __DatiGenerali = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'DatiGenerali'),
                                                             'DatiGenerali',
                                                             '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_FatturaElettronicaBodyType_DatiGenerali',
                                                             False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 37, 6), )
    ...
    __DatiBeniServizi = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'DatiBeniServizi'),
                                                                'DatiBeniServizi',
                                                                '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_FatturaElettronicaBodyType_DatiBeniServizi',
                                                                False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 38, 6), )
    ...
    __DatiVeicoli = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'DatiVeicoli'),
                                                            'DatiVeicoli',
                                                            '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_FatturaElettronicaBodyType_DatiVeicoli',
                                                            False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 39, 6), )
    ...
    __DatiPagamento = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'DatiPagamento'),
                                                              'DatiPagamento',
            ...
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 40, 6), )
    ...
    __Allegati = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'Allegati'), 'Allegati',
                                                         '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_FatturaElettronicaBodyType_Allegati',
                                                         True, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 41, 6), )
...
class DatiTrasmissioneType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 44, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType

    # Element IdTrasmittente uses Python identifier IdTrasmittente
    __IdTrasmittente = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'IdTrasmittente'),
                                                               'IdTrasmittente',
                                                               '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiTrasmissioneType_IdTrasmittente',
                                                               False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 49, 6), )
    ...
    __ProgressivoInvio = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'ProgressivoInvio'),
                                                                 'ProgressivoInvio',
                                                                 '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiTrasmissioneType_ProgressivoInvio',
                                                                 False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 50, 6), )
    ...
    __FormatoTrasmissione = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'FormatoTrasmissione'), 'FormatoTrasmissione',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiTrasmissioneType_FormatoTrasmissione', False,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 51, 6), )
    ...
    __CodiceDestinatario = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'CodiceDestinatario'), 'CodiceDestinatario',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiTrasmissioneType_CodiceDestinatario', False,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 52, 6), )
    ...
    __ContattiTrasmittente = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'ContattiTrasmittente'), 'ContattiTrasmittente',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiTrasmissioneType_ContattiTrasmittente', False,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 53, 6), )
    ...
    __PECDestinatario = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'PECDestinatario'),
                                                                'PECDestinatario',
                                                                '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiTrasmissioneType_PECDestinatario',
                                                                False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 54, 6), )
...
class IdFiscaleType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 62, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType

    # Element IdPaese uses Python identifier IdPaese
    __IdPaese = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'IdPaese'), 'IdPaese',
                                                        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_IdFiscaleType_IdPaese',
                                                        False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 64, 6), )

    IdPaese = property(__IdPaese.value, __IdPaese.set, None, None)

    # Element IdCodice uses Python identifier IdCodice
    __IdCodice = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'IdCodice'), 'IdCodice',
                                                         '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_IdFiscaleType_IdCodice',
                                                         False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 65, 6), )
...
class ContattiTrasmittenteType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 89, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType

    # Element Telefono uses Python identifier Telefono
    __Telefono = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'Telefono'), 'Telefono',
                                                         '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_ContattiTrasmittenteType_Telefono',
                                                         False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 91, 6), )

    Telefono = property(__Telefono.value, __Telefono.set, None, None)

    # Element Email uses Python identifier Email
    __Email = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'Email'), 'Email',
                                                      '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_ContattiTrasmittenteType_Email',
                                                      False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 92, 6), )
...
class DatiGeneraliType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 95, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __DatiGeneraliDocumento = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DatiGeneraliDocumento'), 'DatiGeneraliDocumento',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiGeneraliType_DatiGeneraliDocumento', False,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 102, 6), )
    ...
    __DatiOrdineAcquisto = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DatiOrdineAcquisto'), 'DatiOrdineAcquisto',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiGeneraliType_DatiOrdineAcquisto', True,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 103, 6), )
    ...
    __DatiContratto = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'DatiContratto'),
                                                              'DatiContratto',
                                                              '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiGeneraliType_DatiContratto',
                                                              True, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 104, 6), )
    ...
    __DatiConvenzione = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'DatiConvenzione'),
                                                                'DatiConvenzione',
                                                                '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiGeneraliType_DatiConvenzione',
                                                                True, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 105, 6), )
    ...
    __DatiRicezione = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'DatiRicezione'),
                                                              'DatiRicezione',
                                                              '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiGeneraliType_DatiRicezione',
                                                              True, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 106, 6), )
    ...
    __DatiFattureCollegate = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DatiFattureCollegate'), 'DatiFattureCollegate',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiGeneraliType_DatiFattureCollegate', True,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 107, 6), )
    ...
    __FatturaPrincipale = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'FatturaPrincipale'), 'FatturaPrincipale',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiGeneraliType_FatturaPrincipale', False,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 111, 6), )
...
class DatiGeneraliDocumentoType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __DatiBollo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'DatiBollo'), 'DatiBollo',
                                                          '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiGeneraliDocumentoType_DatiBollo',
                                                          False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 121, 6), )
    ...
    __DatiCassaPrevidenziale = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DatiCassaPrevidenziale'), 'DatiCassaPrevidenziale',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiGeneraliDocumentoType_DatiCassaPrevidenziale',
        True, pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 122, 6), )
    ...
    __ScontoMaggiorazione = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'ScontoMaggiorazione'), 'ScontoMaggiorazione',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiGeneraliDocumentoType_ScontoMaggiorazione', True,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 123, 6), )
    ...
    __ImportoTotaleDocumento = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'ImportoTotaleDocumento'), 'ImportoTotaleDocumento',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiGeneraliDocumentoType_ImportoTotaleDocumento',
        False, pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 124, 6), )
    ...
    __Arrotondamento = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'Arrotondamento'),
                                                               'Arrotondamento',
                                                               '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiGeneraliDocumentoType_Arrotondamento',
                                                               False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 125, 6), )
    ...
    __Causale = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'Causale'), 'Causale',
                                                        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiGeneraliDocumentoType_Causale',
                                                        True, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 126, 6), )

    Causale = property(__Causale.value, __Causale.set, None, None)

    # Element Art73 uses Python identifier Art73
    __Art73 = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'Art73'), 'Art73',
                                                      '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiGeneraliDocumentoType_Art73',
                                                      False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 127, 6), )
...
class DatiRitenutaType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 130, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType

    # Element TipoRitenuta uses Python identifier TipoRitenuta
    __TipoRitenuta = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'TipoRitenuta'),
                                                             'TipoRitenuta',
                                                             '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiRitenutaType_TipoRitenuta',
                                                             False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 132, 6), )
    ...
    __ImportoRitenuta = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'ImportoRitenuta'),
                                                                'ImportoRitenuta',
                                                                '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiRitenutaType_ImportoRitenuta',
                                                                False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 133, 6), )
    ...
    __AliquotaRitenuta = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'AliquotaRitenuta'),
                                                                 'AliquotaRitenuta',
                                                                 '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiRitenutaType_AliquotaRitenuta',
                                                                 False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 134, 6), )
    ...
    __CausalePagamento = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'CausalePagamento'),
                                                                 'CausalePagamento',
                                                                 '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiRitenutaType_CausalePagamento',
                                                                 False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 135, 6), )
...
class DatiBolloType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 138, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType

    # Element BolloVirtuale uses Python identifier BolloVirtuale
    __BolloVirtuale = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'BolloVirtuale'),
                                                              'BolloVirtuale',
                                                              '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiBolloType_BolloVirtuale',
                                                              False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 140, 6), )
    ...
    __ImportoBollo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'ImportoBollo'),
                                                             'ImportoBollo',
                                                             '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiBolloType_ImportoBollo',
                                                             False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 141, 6), )
...
class DatiCassaPrevidenzialeType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 144, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType

    # Element TipoCassa uses Python identifier TipoCassa
    __TipoCassa = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'TipoCassa'), 'TipoCassa',
                                                          '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiCassaPrevidenzialeType_TipoCassa',
                                                          False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 146, 6), )

    TipoCassa = property(__TipoCassa.value, __TipoCassa.set, None, None)

    # Element AlCassa uses Python identifier AlCassa
    __AlCassa = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'AlCassa'), 'AlCassa',
                                                        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiCassaPrevidenzialeType_AlCassa',
                                                        False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 147, 6), )
    ...
    __ImportoContributoCassa = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'ImportoContributoCassa'), 'ImportoContributoCassa',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiCassaPrevidenzialeType_ImportoContributoCassa',
        False, pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 148, 6), )
    ...
    __ImponibileCassa = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'ImponibileCassa'),
                                                                'ImponibileCassa',
                                                                '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiCassaPrevidenzialeType_ImponibileCassa',
                                                                False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 149, 6), )
    ...
    __RiferimentoAmministrazione = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'RiferimentoAmministrazione'), 'RiferimentoAmministrazione',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiCassaPrevidenzialeType_RiferimentoAmministrazione',
        False, pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 153, 6), )

    RiferimentoAmministrazione = property(__RiferimentoAmministrazione.value, __RiferimentoAmministrazione.set, None,
                                          None)
...
class ScontoMaggiorazioneType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 156, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType

    # Element Tipo uses Python identifier Tipo
    __Tipo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'Tipo'), 'Tipo',
                                                     '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_ScontoMaggiorazioneType_Tipo',
                                                     False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 158, 6), )

    Tipo = property(__Tipo.value, __Tipo.set, None, None)

    # Element Percentuale uses Python identifier Percentuale
    __Percentuale = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'Percentuale'),
                                                            'Percentuale',
                                                            '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_ScontoMaggiorazioneType_Percentuale',
                                                            False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 159, 6), )

    Percentuale = property(__Percentuale.value, __Percentuale.set, None, None)

    # Element Importo uses Python identifier Importo
    __Importo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'Importo'), 'Importo',
                                                        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_ScontoMaggiorazioneType_Importo',
                                                        False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 160, 6), )
...
class DatiSALType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 466, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType

    # Element RiferimentoFase uses Python identifier RiferimentoFase
    __RiferimentoFase = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'RiferimentoFase'),
                                                                'RiferimentoFase',
                                                                '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiSALType_RiferimentoFase',
                                                                False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 468, 6), )
...
class DatiDocumentiCorrelatiType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 471, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __RiferimentoNumeroLinea = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'RiferimentoNumeroLinea'), 'RiferimentoNumeroLinea',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiDocumentiCorrelatiType_RiferimentoNumeroLinea',
        True, pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 473, 6), )
    ...
    __IdDocumento = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'IdDocumento'),
                                                            'IdDocumento',
                                                            '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiDocumentiCorrelatiType_IdDocumento',
                                                            False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 474, 6), )
    ...
    __Data = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'Data'), 'Data',
                                                     ...
                                                     False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 475, 6), )

    Data = property(__Data.value, __Data.set, None, None)

    # Element NumItem uses Python identifier NumItem
    __NumItem = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'NumItem'), 'NumItem',
                                                        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiDocumentiCorrelatiType_NumItem',
                                                        False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 476, 6), )
    ...
    __CodiceCommessaConvenzione = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'CodiceCommessaConvenzione'), 'CodiceCommessaConvenzione',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiDocumentiCorrelatiType_CodiceCommessaConvenzione',
        False, pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 477, 6), )
    ...
    __CodiceCUP = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'CodiceCUP'), 'CodiceCUP',
                                                          '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiDocumentiCorrelatiType_CodiceCUP',
                                                          False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 478, 6), )

    CodiceCUP = property(__CodiceCUP.value, __CodiceCUP.set, None, None)

    # Element CodiceCIG uses Python identifier CodiceCIG
    __CodiceCIG = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'CodiceCIG'), 'CodiceCIG',
                                                          '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiDocumentiCorrelatiType_CodiceCIG',
                                                          False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 479, 6), )
...
class DatiDDTType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 488, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType

    # Element NumeroDDT uses Python identifier NumeroDDT
    __NumeroDDT = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'NumeroDDT'), 'NumeroDDT',
                                                          '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiDDTType_NumeroDDT',
                                                          False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 490, 6), )

    NumeroDDT = property(__NumeroDDT.value, __NumeroDDT.set, None, None)

    # Element DataDDT uses Python identifier DataDDT
    __DataDDT = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'DataDDT'), 'DataDDT',
                                                        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiDDTType_DataDDT',
                                                        False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 491, 6), )
    ...
    __RiferimentoNumeroLinea = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'RiferimentoNumeroLinea'), 'RiferimentoNumeroLinea',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiDDTType_RiferimentoNumeroLinea', True,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 492, 6), )
...
class DatiTrasportoType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 495, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __DatiAnagraficiVettore = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DatiAnagraficiVettore'), 'DatiAnagraficiVettore',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiTrasportoType_DatiAnagraficiVettore', False,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 497, 6), )
    ...
    __MezzoTrasporto = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'MezzoTrasporto'),
                                                               'MezzoTrasporto',
                                                               '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiTrasportoType_MezzoTrasporto',
                                                               False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 498, 6), )
    ...
    __CausaleTrasporto = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'CausaleTrasporto'),
                                                                 'CausaleTrasporto',
                                                                 '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiTrasportoType_CausaleTrasporto',
                                                                 False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 499, 6), )
    ...
    __NumeroColli = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'NumeroColli'),
                                                            'NumeroColli',
                                                            '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiTrasportoType_NumeroColli',
                                                            False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 500, 6), )
    ...
    __Descrizione = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'Descrizione'),
                                                            'Descrizione',
                                                            '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiTrasportoType_Descrizione',
                                                            False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 501, 6), )
    ...
    __UnitaMisuraPeso = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'UnitaMisuraPeso'),
                                                                'UnitaMisuraPeso',
                                                                '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiTrasportoType_UnitaMisuraPeso',
                                                                False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 502, 6), )
    ...
    __DataInizioTrasporto = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DataInizioTrasporto'), 'DataInizioTrasporto',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiTrasportoType_DataInizioTrasporto', False,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 506, 6), )
    ...
    __TipoResa = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'TipoResa'), 'TipoResa',
                                                         '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiTrasportoType_TipoResa',
                                                         False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 507, 6), )

    TipoResa = property(__TipoResa.value, __TipoResa.set, None, None)

    # Element IndirizzoResa uses Python identifier IndirizzoResa
    __IndirizzoResa = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'IndirizzoResa'),
                                                              'IndirizzoResa',
                                                              '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiTrasportoType_IndirizzoResa',
                                                              False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 508, 6), )
    ...
    __DataOraConsegna = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'DataOraConsegna'),
                                                                'DataOraConsegna',
                                                                '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiTrasportoType_DataOraConsegna',
                                                                False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 509, 6), )
...
class FatturaPrincipaleType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 522, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __NumeroFatturaPrincipale = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'NumeroFatturaPrincipale'), 'NumeroFatturaPrincipale',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_FatturaPrincipaleType_NumeroFatturaPrincipale', False,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 524, 6), )
    ...
    __DataFatturaPrincipale = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DataFatturaPrincipale'), 'DataFatturaPrincipale',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_FatturaPrincipaleType_DataFatturaPrincipale', False,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 525, 6), )
...
class CedentePrestatoreType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 543, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType

    # Element DatiAnagrafici uses Python identifier DatiAnagrafici
    __DatiAnagrafici = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'DatiAnagrafici'),
                                                               'DatiAnagrafici',
                                                               '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_CedentePrestatoreType_DatiAnagrafici',
                                                               False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 548, 6), )

    DatiAnagrafici = property(__DatiAnagrafici.value, __DatiAnagrafici.set, None, None)

    # Element Sede uses Python identifier Sede
    __Sede = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'Sede'), 'Sede',
                                                     '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_CedentePrestatoreType_Sede',
                                                     False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 549, 6), )
    ...
    __StabileOrganizzazione = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'StabileOrganizzazione'), 'StabileOrganizzazione',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_CedentePrestatoreType_StabileOrganizzazione', False,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 550, 6), )
    ...
    __IscrizioneREA = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'IscrizioneREA'),
                                                              'IscrizioneREA',
                                                              '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_CedentePrestatoreType_IscrizioneREA',
                                                              False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 551, 6), )
    ...
    __Contatti = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'Contatti'), 'Contatti',
                                                         '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_CedentePrestatoreType_Contatti',
                                                         False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 552, 6), )
    ...
    __RiferimentoAmministrazione = pyxb.binding.content.ElementDeclaration(
        ...
        False, pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 553, 6), )
...
class DatiAnagraficiCedenteType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 556, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType

    # Element IdFiscaleIVA uses Python identifier IdFiscaleIVA
    __IdFiscaleIVA = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'IdFiscaleIVA'),
                                                             'IdFiscaleIVA',
                                                             '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiAnagraficiCedenteType_IdFiscaleIVA',
                                                             False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 558, 6), )
    ...
    __CodiceFiscale = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'CodiceFiscale'),
                                                              'CodiceFiscale',
                                                              '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiAnagraficiCedenteType_CodiceFiscale',
                                                              False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 559, 6), )
    ...
    __Anagrafica = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'Anagrafica'),
                                                           'Anagrafica',
                                                           '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiAnagraficiCedenteType_Anagrafica',
                                                           False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 560, 6), )
    ...
    __AlboProfessionale = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'AlboProfessionale'), 'AlboProfessionale',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiAnagraficiCedenteType_AlboProfessionale', False,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 561, 6), )
    ...
    __ProvinciaAlbo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'ProvinciaAlbo'),
                                                              'ProvinciaAlbo',
                                                              '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiAnagraficiCedenteType_ProvinciaAlbo',
                                                              False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 562, 6), )
    ...
    __NumeroIscrizioneAlbo = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'NumeroIscrizioneAlbo'), 'NumeroIscrizioneAlbo',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiAnagraficiCedenteType_NumeroIscrizioneAlbo',
        False, pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 563, 6), )
    ...
    __DataIscrizioneAlbo = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DataIscrizioneAlbo'), 'DataIscrizioneAlbo',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiAnagraficiCedenteType_DataIscrizioneAlbo', False,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 564, 6), )
    ...
    __RegimeFiscale = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'RegimeFiscale'),
                                                              'RegimeFiscale',
                                                              '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiAnagraficiCedenteType_RegimeFiscale',
                                                              False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 565, 6), )
...
class DatiAnagraficiVettoreType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 681, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __IdFiscaleIVA = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'IdFiscaleIVA'),
                                                             ...
                                                             False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 683, 6), )
    ...
    __CodiceFiscale = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'CodiceFiscale'),
                                                              ...
                                                              False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 684, 6), )
    ...
    __Anagrafica = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'Anagrafica'),
                                                           ...
                                                           False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 685, 6), )
    ...
    __NumeroLicenzaGuida = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'NumeroLicenzaGuida'), 'NumeroLicenzaGuida',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiAnagraficiVettoreType_NumeroLicenzaGuida', False,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 686, 6), )
...
class IscrizioneREAType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 689, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType

    # Element Ufficio uses Python identifier Ufficio
    __Ufficio = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'Ufficio'), 'Ufficio',
                                                        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_IscrizioneREAType_Ufficio',
                                                        False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 691, 6), )

    Ufficio = property(__Ufficio.value, __Ufficio.set, None, None)

    # Element NumeroREA uses Python identifier NumeroREA
    __NumeroREA = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'NumeroREA'), 'NumeroREA',
                                                          '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_IscrizioneREAType_NumeroREA',
                                                          False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 692, 6), )
    ...
    __CapitaleSociale = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'CapitaleSociale'),
                                                                'CapitaleSociale',
                                                                '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_IscrizioneREAType_CapitaleSociale',
                                                                False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 693, 6), )
    ...
    __SocioUnico = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'SocioUnico'),
                                                           'SocioUnico',
                                                           '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_IscrizioneREAType_SocioUnico',
                                                           False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 694, 6), )
    ...
    __StatoLiquidazione = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'StatoLiquidazione'), 'StatoLiquidazione',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_IscrizioneREAType_StatoLiquidazione', False,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 695, 6), )
...
class ContattiType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 698, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __Telefono = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'Telefono'), 'Telefono',
                                                         ...
                                                         False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 700, 6), )

    Telefono = property(__Telefono.value, __Telefono.set, None, None)

    # Element Fax uses Python identifier Fax
    __Fax = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'Fax'), 'Fax',
                                                    '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_ContattiType_Fax',
                                                    False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 701, 6), )
    ...
    __Email = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'Email'), 'Email',
                                                      ...
                                                      False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 702, 6), )
...
class RappresentanteFiscaleType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 705, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __DatiAnagrafici = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'DatiAnagrafici'),
                                                               ...
                                                               False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 710, 6), )
...
class DatiAnagraficiRappresentanteType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 713, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __IdFiscaleIVA = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'IdFiscaleIVA'),
                                                             ...
                                                             False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 715, 6), )
    ...
    __CodiceFiscale = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'CodiceFiscale'),
                                                              ...
                                                              False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 716, 6), )
    ...
    __Anagrafica = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'Anagrafica'),
                                                           ...
                                                           False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 717, 6), )
...
class CessionarioCommittenteType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 720, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __DatiAnagrafici = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'DatiAnagrafici'),
                                                               ...
                                                               False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 725, 6), )
    ...
    __Sede = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'Sede'), 'Sede',
                                                     ...
                                                     False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 726, 6), )
    ...
    __StabileOrganizzazione = pyxb.binding.content.ElementDeclaration(
        ...
        False, pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 727, 3), )
    ...
    __RappresentanteFiscale = pyxb.binding.content.ElementDeclaration(
        ...
        False, pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 728, 6), )
...
class RappresentanteFiscaleCessionarioType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 731, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __IdFiscaleIVA = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'IdFiscaleIVA'),
                                                             ...
                                                             False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 733, 3), )
    ...
    __Denominazione = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'Denominazione'),
                                                              ...
                                                              False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 736, 10), )
    ...
    __Nome = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'Nome'), 'Nome',
                                                     ...
                                                     False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 739, 10), )
    ...
    __Cognome = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'Cognome'), 'Cognome',
                                                        ...
                                                        False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 740, 10), )
...
class DatiAnagraficiCessionarioType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 745, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __IdFiscaleIVA = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'IdFiscaleIVA'),
                                                             ...
                                                             False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 747, 6), )
    ...
    __CodiceFiscale = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'CodiceFiscale'),
                                                              ...
                                                              False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 748, 6), )
    ...
    __Anagrafica = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'Anagrafica'),
                                                           ...
                                                           False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 749, 6), )
...
class DatiBeniServiziType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 752, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType

    # Element DettaglioLinee uses Python identifier DettaglioLinee
    __DettaglioLinee = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'DettaglioLinee'),
                                                               'DettaglioLinee',
                                                               '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiBeniServiziType_DettaglioLinee',
                                                               True, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 757, 6), )
    ...
    __DatiRiepilogo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'DatiRiepilogo'),
                                                              'DatiRiepilogo',
                                                              '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiBeniServiziType_DatiRiepilogo',
                                                              True, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 758, 6), )
...
class DatiVeicoliType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 761, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __Data = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'Data'), 'Data',
                                                     ...
                                                     False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 767, 6), )

    Data = property(__Data.value, __Data.set, None, None)

    # Element TotalePercorso uses Python identifier TotalePercorso
    __TotalePercorso = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'TotalePercorso'),
                                                               'TotalePercorso',
                                                               '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiVeicoliType_TotalePercorso',
                                                               False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 768, 6), )
...
class DatiPagamentoType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 771, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __CondizioniPagamento = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'CondizioniPagamento'), 'CondizioniPagamento',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiPagamentoType_CondizioniPagamento', False,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 776, 6), )
    ...
    __DettaglioPagamento = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DettaglioPagamento'), 'DettaglioPagamento',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiPagamentoType_DettaglioPagamento', True,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 777, 6), )
...
class DettaglioPagamentoType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 801, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType

    # Element Beneficiario uses Python identifier Beneficiario
    __Beneficiario = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'Beneficiario'),
                                                             'Beneficiario',
                                                             '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DettaglioPagamentoType_Beneficiario',
                                                             False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 803, 6), )
    ...
    __ModalitaPagamento = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'ModalitaPagamento'), 'ModalitaPagamento',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DettaglioPagamentoType_ModalitaPagamento', False,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 804, 6), )
    ...
    __DataRiferimentoTerminiPagamento = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DataRiferimentoTerminiPagamento'), 'DataRiferimentoTerminiPagamento',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DettaglioPagamentoType_DataRiferimentoTerminiPagamento',
        False, pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 805, 6), )

    DataRiferimentoTerminiPagamento = property(__DataRiferimentoTerminiPagamento.value,
                                               __DataRiferimentoTerminiPagamento.set, None, None)
    ...
    __GiorniTerminiPagamento = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'GiorniTerminiPagamento'), 'GiorniTerminiPagamento',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DettaglioPagamentoType_GiorniTerminiPagamento', False,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 806, 6), )
    ...
    __DataScadenzaPagamento = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DataScadenzaPagamento'), 'DataScadenzaPagamento',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DettaglioPagamentoType_DataScadenzaPagamento', False,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 807, 6), )
    ...
    __ImportoPagamento = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'ImportoPagamento'),
                                                                 'ImportoPagamento',
                                                                 '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DettaglioPagamentoType_ImportoPagamento',
                                                                 False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 808, 6), )
    ...
    __CodUfficioPostale = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'CodUfficioPostale'), 'CodUfficioPostale',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DettaglioPagamentoType_CodUfficioPostale', False,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 809, 6), )
    ...
    __CognomeQuietanzante = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'CognomeQuietanzante'), 'CognomeQuietanzante',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DettaglioPagamentoType_CognomeQuietanzante', False,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 810, 6), )
    ...
    __NomeQuietanzante = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'NomeQuietanzante'),
                                                                 'NomeQuietanzante',
                                                                 '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DettaglioPagamentoType_NomeQuietanzante',
                                                                 False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 811, 6), )
    ...
    __CFQuietanzante = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'CFQuietanzante'),
                                                               'CFQuietanzante',
                                                               '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DettaglioPagamentoType_CFQuietanzante',
                                                               False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 812, 6), )
    ...
    __TitoloQuietanzante = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'TitoloQuietanzante'), 'TitoloQuietanzante',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DettaglioPagamentoType_TitoloQuietanzante', False,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 813, 6), )
    ...
    __IstitutoFinanziario = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'IstitutoFinanziario'), 'IstitutoFinanziario',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DettaglioPagamentoType_IstitutoFinanziario', False,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 814, 6), )
    ...
    __ScontoPagamentoAnticipato = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'ScontoPagamentoAnticipato'), 'ScontoPagamentoAnticipato',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DettaglioPagamentoType_ScontoPagamentoAnticipato',
        False, pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 819, 6), )
    ...
    __DataLimitePagamentoAnticipato = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DataLimitePagamentoAnticipato'), 'DataLimitePagamentoAnticipato',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DettaglioPagamentoType_DataLimitePagamentoAnticipato',
        False, pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 820, 6), )

    DataLimitePagamentoAnticipato = property(__DataLimitePagamentoAnticipato.value, __DataLimitePagamentoAnticipato.set,
                                             None, None)
    ...
    __PenalitaPagamentiRitardati = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'PenalitaPagamentiRitardati'), 'PenalitaPagamentiRitardati',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DettaglioPagamentoType_PenalitaPagamentiRitardati',
        False, pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 821, 6), )

    PenalitaPagamentiRitardati = property(__PenalitaPagamentiRitardati.value, __PenalitaPagamentiRitardati.set, None,
                                          None)
    ...
    __DataDecorrenzaPenale = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DataDecorrenzaPenale'), 'DataDecorrenzaPenale',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DettaglioPagamentoType_DataDecorrenzaPenale', False,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 822, 6), )
    ...
    __CodicePagamento = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'CodicePagamento'),
                                                                'CodicePagamento',
                                                                '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DettaglioPagamentoType_CodicePagamento',
                                                                False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 823, 6), )
...
class TerzoIntermediarioSoggettoEmittenteType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 956, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __DatiAnagrafici = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'DatiAnagrafici'),
                                                               ...
                                                               False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 961, 6), )
...
Namespace.addCategoryObject('typeBinding', 'TerzoIntermediarioSoggettoEmittenteType',
...
class DatiAnagraficiTerzoIntermediarioType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 964, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __IdFiscaleIVA = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'IdFiscaleIVA'),
                                                             ...
                                                             False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 966, 6), )
    ...
    __CodiceFiscale = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'CodiceFiscale'),
                                                              ...
                                                              False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 967, 6), )
    ...
    __Anagrafica = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'Anagrafica'),
                                                           ...
                                                           False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 968, 6), )
...
class AllegatiType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 971, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType

    # Element NomeAttachment uses Python identifier NomeAttachment
    __NomeAttachment = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'NomeAttachment'),
                                                               'NomeAttachment',
                                                               '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_AllegatiType_NomeAttachment',
                                                               False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 976, 6), )
    ...
    __AlgoritmoCompressione = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'AlgoritmoCompressione'), 'AlgoritmoCompressione',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_AllegatiType_AlgoritmoCompressione', False,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 977, 6), )
    ...
    __FormatoAttachment = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'FormatoAttachment'), 'FormatoAttachment',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_AllegatiType_FormatoAttachment', False,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 978, 6), )
    ...
    __DescrizioneAttachment = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DescrizioneAttachment'), 'DescrizioneAttachment',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_AllegatiType_DescrizioneAttachment', False,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 979, 6), )
    ...
    __Attachment = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'Attachment'),
                                                           'Attachment',
                                                           '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_AllegatiType_Attachment',
                                                           False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 980, 6), )
...
class DettaglioLineeType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 983, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType

    # Element NumeroLinea uses Python identifier NumeroLinea
    __NumeroLinea = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'NumeroLinea'),
                                                            'NumeroLinea',
                                                            '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DettaglioLineeType_NumeroLinea',
                                                            False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 985, 6), )
    ...
    __TipoCessionePrestazione = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'TipoCessionePrestazione'), 'TipoCessionePrestazione',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DettaglioLineeType_TipoCessionePrestazione', False,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 986, 6), )
    ...
    __CodiceArticolo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'CodiceArticolo'),
                                                               'CodiceArticolo',
                                                               '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DettaglioLineeType_CodiceArticolo',
                                                               True, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 987, 6), )
    ...
    __Descrizione = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'Descrizione'),
                                                            ...
                                                            False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 988, 6), )

    Descrizione = property(__Descrizione.value, __Descrizione.set, None, None)

    # Element Quantita uses Python identifier Quantita
    __Quantita = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'Quantita'), 'Quantita',
                                                         '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DettaglioLineeType_Quantita',
                                                         False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 989, 6), )

    Quantita = property(__Quantita.value, __Quantita.set, None, None)

    # Element UnitaMisura uses Python identifier UnitaMisura
    __UnitaMisura = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'UnitaMisura'),
                                                            'UnitaMisura',
                                                            '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DettaglioLineeType_UnitaMisura',
                                                            False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 990, 6), )
    ...
    __DataInizioPeriodo = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DataInizioPeriodo'), 'DataInizioPeriodo',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DettaglioLineeType_DataInizioPeriodo', False,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 991, 6), )
    ...
    __DataFinePeriodo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'DataFinePeriodo'),
                                                                'DataFinePeriodo',
                                                                '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DettaglioLineeType_DataFinePeriodo',
                                                                False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 992, 6), )
    ...
    __PrezzoUnitario = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'PrezzoUnitario'),
                                                               'PrezzoUnitario',
                                                               '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DettaglioLineeType_PrezzoUnitario',
                                                               False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 993, 6), )
    ...
    __ScontoMaggiorazione = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'ScontoMaggiorazione'), 'ScontoMaggiorazione',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DettaglioLineeType_ScontoMaggiorazione', True,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 994, 6), )

    ScontoMaggiorazione = property(__ScontoMaggiorazione.value, __ScontoMaggiorazione.set, None, None)

    # Element PrezzoTotale uses Python identifier PrezzoTotale
    __PrezzoTotale = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'PrezzoTotale'),
                                                             'PrezzoTotale',
                                                             '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DettaglioLineeType_PrezzoTotale',
                                                             False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 995, 6), )
    ...
    __AliquotaIVA = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'AliquotaIVA'),
                                                            ...
                                                            False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 996, 6), )
    ...
    __Ritenuta = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'Ritenuta'), 'Ritenuta',
                                                         ...
                                                         False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 997, 6), )
    ...
    __Natura = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'Natura'), 'Natura',
                                                       ...
                                                       False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 998, 6), )
    ...
    __RiferimentoAmministrazione = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'RiferimentoAmministrazione'), 'RiferimentoAmministrazione',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DettaglioLineeType_RiferimentoAmministrazione', False,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 999, 6), )
    ...
    __AltriDatiGestionali = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'AltriDatiGestionali'), 'AltriDatiGestionali',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DettaglioLineeType_AltriDatiGestionali', True,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1000, 6), )
...
class CodiceArticoloType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1003, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType

    # Element CodiceTipo uses Python identifier CodiceTipo
    __CodiceTipo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'CodiceTipo'),
                                                           'CodiceTipo',
                                                           '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_CodiceArticoloType_CodiceTipo',
                                                           False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1005, 6), )
    ...
    __CodiceValore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'CodiceValore'),
                                                             'CodiceValore',
                                                             '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_CodiceArticoloType_CodiceValore',
                                                             False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1006, 6), )
...
class AltriDatiGestionaliType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1009, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType

    # Element TipoDato uses Python identifier TipoDato
    __TipoDato = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'TipoDato'), 'TipoDato',
                                                         '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_AltriDatiGestionaliType_TipoDato',
                                                         False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1011, 6), )
    ...
    __RiferimentoTesto = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'RiferimentoTesto'),
                                                                 'RiferimentoTesto',
                                                                 '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_AltriDatiGestionaliType_RiferimentoTesto',
                                                                 False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1012, 6), )
    ...
    __RiferimentoNumero = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'RiferimentoNumero'), 'RiferimentoNumero',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_AltriDatiGestionaliType_RiferimentoNumero', False,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1013, 6), )
    ...
    __RiferimentoData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'RiferimentoData'),
                                                                'RiferimentoData',
                                                                '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_AltriDatiGestionaliType_RiferimentoData',
                                                                False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1014, 6), )
...
class DatiRiepilogoType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1027, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __AliquotaIVA = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'AliquotaIVA'),
                                                            ...
                                                            False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1029, 6), )
    ...
    __Natura = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'Natura'), 'Natura',
                                                       ...
                                                       False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1030, 6), )

    Natura = property(__Natura.value, __Natura.set, None, None)

    # Element SpeseAccessorie uses Python identifier SpeseAccessorie
    __SpeseAccessorie = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'SpeseAccessorie'),
                                                                'SpeseAccessorie',
                                                                '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiRiepilogoType_SpeseAccessorie',
                                                                False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1031, 6), )
    ...
    __Arrotondamento = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'Arrotondamento'),
                                                               ...
                                                               False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1032, 6), )
    ...
    __ImponibileImporto = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'ImponibileImporto'), 'ImponibileImporto',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiRiepilogoType_ImponibileImporto', False,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1033, 6), )
    ...
    __Imposta = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'Imposta'), 'Imposta',
                                                        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiRiepilogoType_Imposta',
                                                        False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1034, 6), )

    Imposta = property(__Imposta.value, __Imposta.set, None, None)

    # Element EsigibilitaIVA uses Python identifier EsigibilitaIVA
    __EsigibilitaIVA = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'EsigibilitaIVA'),
                                                               'EsigibilitaIVA',
                                                               '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiRiepilogoType_EsigibilitaIVA',
                                                               False, pyxb.utils.utility.Location(
            '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1035, 6), )
    ...
    __RiferimentoNormativo = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'RiferimentoNormativo'), 'RiferimentoNormativo',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_DatiRiepilogoType_RiferimentoNormativo', False,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1036, 6), )
...
class FatturaElettronicaType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 16, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __FatturaElettronicaHeader = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'FatturaElettronicaHeader'), 'FatturaElettronicaHeader',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_FatturaElettronicaType_FatturaElettronicaHeader',
        False, pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 18, 6), )
    ...
    __FatturaElettronicaBody = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'FatturaElettronicaBody'), 'FatturaElettronicaBody',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_FatturaElettronicaType_FatturaElettronicaBody', True,
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 19, 6), )
    ...
    __Signature = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(_Namespace_ds, 'Signature'),
                                                          'Signature',
    ...
    __versione = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'versione'), 'versione',
                                                   '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_FatturaElettronicaType_versione',
                                                   FormatoTrasmissioneType, required=True)
    __versione._DeclarationLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 22,
                                                                  4)
    __versione._UseLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 22, 4)
    ...
    __SistemaEmittente = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'SistemaEmittente'),
                                                           'SistemaEmittente',
    ...
    __SistemaEmittente._DeclarationLocation = pyxb.utils.utility.Location(
        '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 23, 4)
    __SistemaEmittente._UseLocation = pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 23,
                                                                  4)
...
FatturaElettronica = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'FatturaElettronica'),
                                                FatturaElettronicaType,
                                                documentation='XML schema fatture destinate a PA e privati in forma ordinaria 1.2.1',
                                                location=pyxb.utils.utility.Location(
                                                    '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 10, 2))
...
FatturaElettronicaHeaderType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DatiTrasmissione'), DatiTrasmissioneType,
                               scope=FatturaElettronicaHeaderType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    27, 6)))

FatturaElettronicaHeaderType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'CedentePrestatore'), CedentePrestatoreType,
                               scope=FatturaElettronicaHeaderType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    28, 6)))

FatturaElettronicaHeaderType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'RappresentanteFiscale'), RappresentanteFiscaleType,
                               scope=FatturaElettronicaHeaderType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    29, 6)))

FatturaElettronicaHeaderType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'CessionarioCommittente'), CessionarioCommittenteType,
                               scope=FatturaElettronicaHeaderType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    30, 6)))

FatturaElettronicaHeaderType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'TerzoIntermediarioOSoggettoEmittente'),
                               TerzoIntermediarioSoggettoEmittenteType, scope=FatturaElettronicaHeaderType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    31, 6)))

FatturaElettronicaHeaderType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'SoggettoEmittente'), SoggettoEmittenteType,
                               scope=FatturaElettronicaHeaderType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    32, 6)))
...
def _BuildAutomaton():
    ...
    cc_0 = fac.CounterCondition(min=0, max=1,
                                metadata=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                     29, 6))
    counters.add(cc_0)
    ...
    symbol = pyxb.binding.content.ElementUse(
        FatturaElettronicaHeaderType._UseForTag(pyxb.namespace.ExpandedName(None, 'DatiTrasmissione')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 27, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        FatturaElettronicaHeaderType._UseForTag(pyxb.namespace.ExpandedName(None, 'CedentePrestatore')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 28, 6))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        FatturaElettronicaHeaderType._UseForTag(pyxb.namespace.ExpandedName(None, 'RappresentanteFiscale')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 29, 6))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        FatturaElettronicaHeaderType._UseForTag(pyxb.namespace.ExpandedName(None, 'CessionarioCommittente')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 30, 6))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(FatturaElettronicaHeaderType._UseForTag(
        pyxb.namespace.ExpandedName(None, 'TerzoIntermediarioOSoggettoEmittente')), pyxb.utils.utility.Location(
        '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 31, 6))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(
        FatturaElettronicaHeaderType._UseForTag(pyxb.namespace.ExpandedName(None, 'SoggettoEmittente')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 32, 6))
...
FatturaElettronicaBodyType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DatiGenerali'), DatiGeneraliType,
                               scope=FatturaElettronicaBodyType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    37, 6)))

FatturaElettronicaBodyType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DatiBeniServizi'), DatiBeniServiziType,
                               scope=FatturaElettronicaBodyType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    38, 6)))

FatturaElettronicaBodyType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DatiVeicoli'), DatiVeicoliType,
                               scope=FatturaElettronicaBodyType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    39, 6)))

FatturaElettronicaBodyType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DatiPagamento'), DatiPagamentoType,
                               scope=FatturaElettronicaBodyType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    40, 6)))

FatturaElettronicaBodyType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Allegati'), AllegatiType,
                               scope=FatturaElettronicaBodyType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    41, 6)))
...
def _BuildAutomaton_():
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        FatturaElettronicaBodyType._UseForTag(pyxb.namespace.ExpandedName(None, 'DatiGenerali')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 37, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        FatturaElettronicaBodyType._UseForTag(pyxb.namespace.ExpandedName(None, 'DatiBeniServizi')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 38, 6))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(
        FatturaElettronicaBodyType._UseForTag(pyxb.namespace.ExpandedName(None, 'DatiVeicoli')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 39, 6))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(
        FatturaElettronicaBodyType._UseForTag(pyxb.namespace.ExpandedName(None, 'DatiPagamento')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 40, 6))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(
        FatturaElettronicaBodyType._UseForTag(pyxb.namespace.ExpandedName(None, 'Allegati')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 41, 6))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
DatiTrasmissioneType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'IdTrasmittente'), IdFiscaleType,
                               scope=DatiTrasmissioneType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    49, 6)))

DatiTrasmissioneType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'ProgressivoInvio'), String10Type,
                               scope=DatiTrasmissioneType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    50, 6)))

DatiTrasmissioneType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'FormatoTrasmissione'), FormatoTrasmissioneType,
                               scope=DatiTrasmissioneType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    51, 6)))

DatiTrasmissioneType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'CodiceDestinatario'), CodiceDestinatarioType,
                               scope=DatiTrasmissioneType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    52, 6)))

DatiTrasmissioneType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'ContattiTrasmittente'), ContattiTrasmittenteType,
                               scope=DatiTrasmissioneType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    53, 6)))

DatiTrasmissioneType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'PECDestinatario'), EmailType,
                               scope=DatiTrasmissioneType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    54, 6)))
...
def _BuildAutomaton_2():
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiTrasmissioneType._UseForTag(pyxb.namespace.ExpandedName(None, 'IdTrasmittente')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 49, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiTrasmissioneType._UseForTag(pyxb.namespace.ExpandedName(None, 'ProgressivoInvio')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 50, 6))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiTrasmissioneType._UseForTag(pyxb.namespace.ExpandedName(None, 'FormatoTrasmissione')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 51, 6))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        DatiTrasmissioneType._UseForTag(pyxb.namespace.ExpandedName(None, 'CodiceDestinatario')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 52, 6))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiTrasmissioneType._UseForTag(pyxb.namespace.ExpandedName(None, 'ContattiTrasmittente')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 53, 6))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiTrasmissioneType._UseForTag(pyxb.namespace.ExpandedName(None, 'PECDestinatario')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 54, 6))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
IdFiscaleType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'IdPaese'), NazioneType, scope=IdFiscaleType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    64, 6)))

IdFiscaleType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'IdCodice'), CodiceType, scope=IdFiscaleType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    65, 6)))
...
def _BuildAutomaton_3():
    ...
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(IdFiscaleType._UseForTag(pyxb.namespace.ExpandedName(None, 'IdPaese')),
                                             pyxb.utils.utility.Location(
                                                 '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 64, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(IdFiscaleType._UseForTag(pyxb.namespace.ExpandedName(None, 'IdCodice')),
                                             pyxb.utils.utility.Location(
                                                 '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 65, 6))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
...
ContattiTrasmittenteType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Telefono'), TelFaxType,
                               scope=ContattiTrasmittenteType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    91, 6)))

ContattiTrasmittenteType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Email'), EmailType, scope=ContattiTrasmittenteType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    92, 6)))
...
def _BuildAutomaton_4():
    ...
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(
        ContattiTrasmittenteType._UseForTag(pyxb.namespace.ExpandedName(None, 'Telefono')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 91, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(
        ...
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 92, 6))
...
DatiGeneraliType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DatiGeneraliDocumento'), DatiGeneraliDocumentoType,
                               scope=DatiGeneraliType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    102, 6)))

DatiGeneraliType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DatiOrdineAcquisto'), DatiDocumentiCorrelatiType,
                               scope=DatiGeneraliType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    103, 6)))

DatiGeneraliType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DatiContratto'), DatiDocumentiCorrelatiType,
                               scope=DatiGeneraliType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    104, 6)))

DatiGeneraliType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DatiConvenzione'), DatiDocumentiCorrelatiType,
                               scope=DatiGeneraliType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    105, 6)))

DatiGeneraliType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DatiRicezione'), DatiDocumentiCorrelatiType,
                               scope=DatiGeneraliType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    106, 6)))

DatiGeneraliType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DatiFattureCollegate'), DatiDocumentiCorrelatiType,
                               scope=DatiGeneraliType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    107, 6)))

DatiGeneraliType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DatiSAL'), DatiSALType, scope=DatiGeneraliType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    108, 6)))

DatiGeneraliType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DatiDDT'), DatiDDTType, scope=DatiGeneraliType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    109, 6)))

DatiGeneraliType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DatiTrasporto'), DatiTrasportoType,
                               scope=DatiGeneraliType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    110, 6)))

DatiGeneraliType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'FatturaPrincipale'), FatturaPrincipaleType,
                               scope=DatiGeneraliType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    111, 6)))
...
def _BuildAutomaton_5():
    ...
    cc_4 = fac.CounterCondition(min=0, max=None,
                                metadata=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                     107, 6))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=None,
                                metadata=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                     108, 6))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=None,
                                metadata=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                     109, 6))
    counters.add(cc_6)
    ...
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        DatiGeneraliType._UseForTag(pyxb.namespace.ExpandedName(None, 'DatiGeneraliDocumento')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 102, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiGeneraliType._UseForTag(pyxb.namespace.ExpandedName(None, 'DatiOrdineAcquisto')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 103, 6))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    ...
    symbol = pyxb.binding.content.ElementUse(
        ...
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 104, 6))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiGeneraliType._UseForTag(pyxb.namespace.ExpandedName(None, 'DatiConvenzione')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 105, 6))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    ...
    symbol = pyxb.binding.content.ElementUse(
        ...
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 106, 6))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiGeneraliType._UseForTag(pyxb.namespace.ExpandedName(None, 'DatiFattureCollegate')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 107, 6))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(DatiGeneraliType._UseForTag(pyxb.namespace.ExpandedName(None, 'DatiSAL')),
                                             pyxb.utils.utility.Location(
                                                 '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 108, 6))
    ...
    symbol = pyxb.binding.content.ElementUse(DatiGeneraliType._UseForTag(pyxb.namespace.ExpandedName(None, 'DatiDDT')),
                                             pyxb.utils.utility.Location(
                                                 '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 109, 6))
    ...
    symbol = pyxb.binding.content.ElementUse(
        ...
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 110, 6))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_8, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiGeneraliType._UseForTag(pyxb.namespace.ExpandedName(None, 'FatturaPrincipale')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 111, 6))
...
DatiGeneraliDocumentoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'TipoDocumento'), TipoDocumentoType,
                               scope=DatiGeneraliDocumentoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    116, 6)))

DatiGeneraliDocumentoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Divisa'), DivisaType, scope=DatiGeneraliDocumentoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    117, 6)))

DatiGeneraliDocumentoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Data'), DataFatturaType,
                               scope=DatiGeneraliDocumentoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    118, 6)))

DatiGeneraliDocumentoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Numero'), String20Type,
                               scope=DatiGeneraliDocumentoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    119, 6)))

DatiGeneraliDocumentoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DatiRitenuta'), DatiRitenutaType,
                               scope=DatiGeneraliDocumentoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    120, 6)))

DatiGeneraliDocumentoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DatiBollo'), DatiBolloType,
                               scope=DatiGeneraliDocumentoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    121, 6)))

DatiGeneraliDocumentoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DatiCassaPrevidenziale'), DatiCassaPrevidenzialeType,
                               scope=DatiGeneraliDocumentoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    122, 6)))

DatiGeneraliDocumentoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'ScontoMaggiorazione'), ScontoMaggiorazioneType,
                               scope=DatiGeneraliDocumentoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    123, 6)))

DatiGeneraliDocumentoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'ImportoTotaleDocumento'), Amount2DecimalType,
                               scope=DatiGeneraliDocumentoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    124, 6)))

DatiGeneraliDocumentoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Arrotondamento'), Amount2DecimalType,
                               scope=DatiGeneraliDocumentoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    125, 6)))

DatiGeneraliDocumentoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Causale'), String200LatinType,
                               scope=DatiGeneraliDocumentoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    126, 6)))

DatiGeneraliDocumentoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Art73'), Art73Type, scope=DatiGeneraliDocumentoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    127, 6)))
...
def _BuildAutomaton_6():
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiGeneraliDocumentoType._UseForTag(pyxb.namespace.ExpandedName(None, 'TipoDocumento')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 116, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiGeneraliDocumentoType._UseForTag(pyxb.namespace.ExpandedName(None, 'Divisa')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 117, 6))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiGeneraliDocumentoType._UseForTag(pyxb.namespace.ExpandedName(None, 'Data')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 118, 6))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        DatiGeneraliDocumentoType._UseForTag(pyxb.namespace.ExpandedName(None, 'Numero')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 119, 6))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiGeneraliDocumentoType._UseForTag(pyxb.namespace.ExpandedName(None, 'DatiRitenuta')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 120, 6))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiGeneraliDocumentoType._UseForTag(pyxb.namespace.ExpandedName(None, 'DatiBollo')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 121, 6))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiGeneraliDocumentoType._UseForTag(pyxb.namespace.ExpandedName(None, 'DatiCassaPrevidenziale')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 122, 6))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiGeneraliDocumentoType._UseForTag(pyxb.namespace.ExpandedName(None, 'ScontoMaggiorazione')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 123, 6))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiGeneraliDocumentoType._UseForTag(pyxb.namespace.ExpandedName(None, 'ImportoTotaleDocumento')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 124, 6))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiGeneraliDocumentoType._UseForTag(pyxb.namespace.ExpandedName(None, 'Arrotondamento')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 125, 6))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiGeneraliDocumentoType._UseForTag(pyxb.namespace.ExpandedName(None, 'Causale')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 126, 6))
    st_10 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiGeneraliDocumentoType._UseForTag(pyxb.namespace.ExpandedName(None, 'Art73')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 127, 6))
...
DatiRitenutaType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'TipoRitenuta'), TipoRitenutaType,
                               scope=DatiRitenutaType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    132, 6)))

DatiRitenutaType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'ImportoRitenuta'), Amount2DecimalType,
                               scope=DatiRitenutaType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    133, 6)))

DatiRitenutaType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'AliquotaRitenuta'), RateType, scope=DatiRitenutaType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    134, 6)))

DatiRitenutaType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'CausalePagamento'), CausalePagamentoType,
                               scope=DatiRitenutaType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    135, 6)))
...
def _BuildAutomaton_7():
    ...
    symbol = pyxb.binding.content.ElementUse(
        ...
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 132, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiRitenutaType._UseForTag(pyxb.namespace.ExpandedName(None, 'ImportoRitenuta')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 133, 6))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiRitenutaType._UseForTag(pyxb.namespace.ExpandedName(None, 'AliquotaRitenuta')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 134, 6))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        DatiRitenutaType._UseForTag(pyxb.namespace.ExpandedName(None, 'CausalePagamento')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 135, 6))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
DatiBolloType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'BolloVirtuale'), BolloVirtualeType,
                               scope=DatiBolloType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    140, 6)))

DatiBolloType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'ImportoBollo'), Amount2DecimalType,
                               scope=DatiBolloType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    141, 6)))
...
def _BuildAutomaton_8():
    ...
    symbol = pyxb.binding.content.ElementUse(
        ...
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 140, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(
        ...
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 141, 6))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
DatiCassaPrevidenzialeType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'TipoCassa'), TipoCassaType,
                               scope=DatiCassaPrevidenzialeType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    146, 6)))

DatiCassaPrevidenzialeType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'AlCassa'), RateType, scope=DatiCassaPrevidenzialeType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    147, 6)))

DatiCassaPrevidenzialeType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'ImportoContributoCassa'), Amount2DecimalType,
                               scope=DatiCassaPrevidenzialeType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    148, 6)))

DatiCassaPrevidenzialeType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'ImponibileCassa'), Amount2DecimalType,
                               scope=DatiCassaPrevidenzialeType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    149, 6)))

DatiCassaPrevidenzialeType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'AliquotaIVA'), RateType,
                               scope=DatiCassaPrevidenzialeType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    150, 6)))

DatiCassaPrevidenzialeType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Ritenuta'), RitenutaType,
                               scope=DatiCassaPrevidenzialeType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    151, 6)))

DatiCassaPrevidenzialeType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Natura'), NaturaType,
                               scope=DatiCassaPrevidenzialeType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    152, 6)))

DatiCassaPrevidenzialeType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'RiferimentoAmministrazione'), String20Type,
                               scope=DatiCassaPrevidenzialeType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    153, 6)))
...
def _BuildAutomaton_9():
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiCassaPrevidenzialeType._UseForTag(pyxb.namespace.ExpandedName(None, 'TipoCassa')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 146, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiCassaPrevidenzialeType._UseForTag(pyxb.namespace.ExpandedName(None, 'AlCassa')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 147, 6))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiCassaPrevidenzialeType._UseForTag(pyxb.namespace.ExpandedName(None, 'ImportoContributoCassa')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 148, 6))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiCassaPrevidenzialeType._UseForTag(pyxb.namespace.ExpandedName(None, 'ImponibileCassa')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 149, 6))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        DatiCassaPrevidenzialeType._UseForTag(pyxb.namespace.ExpandedName(None, 'AliquotaIVA')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 150, 6))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiCassaPrevidenzialeType._UseForTag(pyxb.namespace.ExpandedName(None, 'Ritenuta')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 151, 6))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiCassaPrevidenzialeType._UseForTag(pyxb.namespace.ExpandedName(None, 'Natura')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 152, 6))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiCassaPrevidenzialeType._UseForTag(pyxb.namespace.ExpandedName(None, 'RiferimentoAmministrazione')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 153, 6))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
ScontoMaggiorazioneType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Tipo'), TipoScontoMaggiorazioneType,
                               scope=ScontoMaggiorazioneType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    158, 6)))

ScontoMaggiorazioneType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Percentuale'), RateType,
                               scope=ScontoMaggiorazioneType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    159, 6)))

ScontoMaggiorazioneType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Importo'), Amount8DecimalType,
                               scope=ScontoMaggiorazioneType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    160, 6)))
...
def _BuildAutomaton_10():
    ...
    symbol = pyxb.binding.content.ElementUse(
        ...
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 158, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(
        ScontoMaggiorazioneType._UseForTag(pyxb.namespace.ExpandedName(None, 'Percentuale')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 159, 6))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(
        ScontoMaggiorazioneType._UseForTag(pyxb.namespace.ExpandedName(None, 'Importo')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 160, 6))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
DatiSALType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'RiferimentoFase'), RiferimentoFaseType,
                               scope=DatiSALType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    468, 6)))
...
def _BuildAutomaton_11():
    ...
    symbol = pyxb.binding.content.ElementUse(
        ...
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 468, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    st_0._set_transitionSet(transitions)
...
DatiDocumentiCorrelatiType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'RiferimentoNumeroLinea'), RiferimentoNumeroLineaType,
                               scope=DatiDocumentiCorrelatiType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    473, 6)))

DatiDocumentiCorrelatiType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'IdDocumento'), String20Type,
                               scope=DatiDocumentiCorrelatiType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    474, 6)))

DatiDocumentiCorrelatiType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Data'), pyxb.binding.datatypes.date,
                               scope=DatiDocumentiCorrelatiType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    475, 6)))

DatiDocumentiCorrelatiType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'NumItem'), String20Type,
                               scope=DatiDocumentiCorrelatiType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    476, 6)))

DatiDocumentiCorrelatiType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'CodiceCommessaConvenzione'), String100LatinType,
                               scope=DatiDocumentiCorrelatiType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    477, 6)))

DatiDocumentiCorrelatiType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'CodiceCUP'), String15Type,
                               scope=DatiDocumentiCorrelatiType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    478, 6)))

DatiDocumentiCorrelatiType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'CodiceCIG'), String15Type,
                               scope=DatiDocumentiCorrelatiType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    479, 6)))
...
def _BuildAutomaton_12():
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiDocumentiCorrelatiType._UseForTag(pyxb.namespace.ExpandedName(None, 'RiferimentoNumeroLinea')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 473, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        DatiDocumentiCorrelatiType._UseForTag(pyxb.namespace.ExpandedName(None, 'IdDocumento')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 474, 6))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiDocumentiCorrelatiType._UseForTag(pyxb.namespace.ExpandedName(None, 'Data')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 475, 6))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiDocumentiCorrelatiType._UseForTag(pyxb.namespace.ExpandedName(None, 'NumItem')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 476, 6))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiDocumentiCorrelatiType._UseForTag(pyxb.namespace.ExpandedName(None, 'CodiceCommessaConvenzione')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 477, 6))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiDocumentiCorrelatiType._UseForTag(pyxb.namespace.ExpandedName(None, 'CodiceCUP')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 478, 6))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiDocumentiCorrelatiType._UseForTag(pyxb.namespace.ExpandedName(None, 'CodiceCIG')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 479, 6))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
DatiDDTType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'NumeroDDT'), String20Type, scope=DatiDDTType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    490, 6)))

DatiDDTType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DataDDT'), pyxb.binding.datatypes.date,
                               scope=DatiDDTType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    491, 6)))
...
def _BuildAutomaton_13():
    ...
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(DatiDDTType._UseForTag(pyxb.namespace.ExpandedName(None, 'NumeroDDT')),
                                             pyxb.utils.utility.Location(
                                                 '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 490, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(DatiDDTType._UseForTag(pyxb.namespace.ExpandedName(None, 'DataDDT')),
                                             pyxb.utils.utility.Location(
                                                 '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 491, 6))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    ...
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiDDTType._UseForTag(pyxb.namespace.ExpandedName(None, 'RiferimentoNumeroLinea')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 492, 6))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    transitions = []
...
DatiTrasportoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DatiAnagraficiVettore'), DatiAnagraficiVettoreType,
                               scope=DatiTrasportoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    497, 6)))

DatiTrasportoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'MezzoTrasporto'), String80LatinType,
                               scope=DatiTrasportoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    498, 6)))

DatiTrasportoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'CausaleTrasporto'), String100LatinType,
                               scope=DatiTrasportoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    499, 6)))

DatiTrasportoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'NumeroColli'), NumeroColliType,
                               scope=DatiTrasportoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    500, 6)))

DatiTrasportoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Descrizione'), String100LatinType,
                               scope=DatiTrasportoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    501, 6)))

DatiTrasportoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'UnitaMisuraPeso'), String10Type,
                               scope=DatiTrasportoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    502, 6)))

DatiTrasportoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'PesoLordo'), PesoType, scope=DatiTrasportoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    503, 6)))

DatiTrasportoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'PesoNetto'), PesoType, scope=DatiTrasportoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    504, 6)))

DatiTrasportoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DataOraRitiro'), pyxb.binding.datatypes.dateTime,
                               scope=DatiTrasportoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    505, 6)))

DatiTrasportoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DataInizioTrasporto'), pyxb.binding.datatypes.date,
                               scope=DatiTrasportoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    506, 6)))

DatiTrasportoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'TipoResa'), TipoResaType, scope=DatiTrasportoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    507, 6)))

DatiTrasportoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'IndirizzoResa'), IndirizzoType,
                               scope=DatiTrasportoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    508, 6)))

DatiTrasportoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DataOraConsegna'), pyxb.binding.datatypes.dateTime,
                               scope=DatiTrasportoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    509, 6)))
...
def _BuildAutomaton_14():
    ...
    cc_10 = fac.CounterCondition(min=0, max=1,
                                 metadata=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                      507, 6))
    counters.add(cc_10)
    cc_11 = fac.CounterCondition(min=0, max=1,
                                 metadata=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                      508, 6))
    counters.add(cc_11)
    cc_12 = fac.CounterCondition(min=0, max=1,
                                 metadata=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                      509, 6))
    counters.add(cc_12)
    states = []
    ...
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiTrasportoType._UseForTag(pyxb.namespace.ExpandedName(None, 'DatiAnagraficiVettore')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 497, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiTrasportoType._UseForTag(pyxb.namespace.ExpandedName(None, 'MezzoTrasporto')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 498, 6))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiTrasportoType._UseForTag(pyxb.namespace.ExpandedName(None, 'CausaleTrasporto')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 499, 6))
    ...
    symbol = pyxb.binding.content.ElementUse(
        ...
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 500, 6))
    ...
    symbol = pyxb.binding.content.ElementUse(
        ...
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 501, 6))
    st_4 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiTrasportoType._UseForTag(pyxb.namespace.ExpandedName(None, 'UnitaMisuraPeso')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 502, 6))
    ...
    symbol = pyxb.binding.content.ElementUse(
        ...
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 503, 6))
    ...
    symbol = pyxb.binding.content.ElementUse(
        ...
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 504, 6))
    st_7 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_8, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiTrasportoType._UseForTag(pyxb.namespace.ExpandedName(None, 'DataOraRitiro')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 505, 6))
    st_8 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_9, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiTrasportoType._UseForTag(pyxb.namespace.ExpandedName(None, 'DataInizioTrasporto')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 506, 6))
    ...
    symbol = pyxb.binding.content.ElementUse(
        ...
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 507, 6))
    st_10 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_11, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiTrasportoType._UseForTag(pyxb.namespace.ExpandedName(None, 'IndirizzoResa')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 508, 6))
    st_11 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_12, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiTrasportoType._UseForTag(pyxb.namespace.ExpandedName(None, 'DataOraConsegna')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 509, 6))
...
IndirizzoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Indirizzo'), String60LatinType, scope=IndirizzoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    514, 6)))

IndirizzoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'NumeroCivico'), NumeroCivicoType, scope=IndirizzoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    515, 6)))

IndirizzoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'CAP'), CAPType, scope=IndirizzoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    516, 6)))

IndirizzoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Comune'), String60LatinType, scope=IndirizzoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    517, 6)))

IndirizzoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Provincia'), ProvinciaType, scope=IndirizzoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    518, 6)))

IndirizzoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Nazione'), NazioneType, scope=IndirizzoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    519, 6), unicode_default='IT'))
...
def _BuildAutomaton_15():
    ...
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(IndirizzoType._UseForTag(pyxb.namespace.ExpandedName(None, 'Indirizzo')),
                                             pyxb.utils.utility.Location(
                                                 '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 514, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    ...
    symbol = pyxb.binding.content.ElementUse(
        ...
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 515, 6))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(IndirizzoType._UseForTag(pyxb.namespace.ExpandedName(None, 'CAP')),
                                             pyxb.utils.utility.Location(
                                                 '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 516, 6))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(IndirizzoType._UseForTag(pyxb.namespace.ExpandedName(None, 'Comune')),
                                             pyxb.utils.utility.Location(
                                                 '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 517, 6))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(IndirizzoType._UseForTag(pyxb.namespace.ExpandedName(None, 'Provincia')),
                                             pyxb.utils.utility.Location(
                                                 '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 518, 6))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(IndirizzoType._UseForTag(pyxb.namespace.ExpandedName(None, 'Nazione')),
                                             pyxb.utils.utility.Location(
                                                 '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 519, 6))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
...
FatturaPrincipaleType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'NumeroFatturaPrincipale'), String20Type,
                               scope=FatturaPrincipaleType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    524, 6)))

FatturaPrincipaleType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DataFatturaPrincipale'), pyxb.binding.datatypes.date,
                               scope=FatturaPrincipaleType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    525, 6)))
...
def _BuildAutomaton_16():
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        FatturaPrincipaleType._UseForTag(pyxb.namespace.ExpandedName(None, 'NumeroFatturaPrincipale')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 524, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        FatturaPrincipaleType._UseForTag(pyxb.namespace.ExpandedName(None, 'DataFatturaPrincipale')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 525, 6))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
...
CedentePrestatoreType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DatiAnagrafici'), DatiAnagraficiCedenteType,
                               scope=CedentePrestatoreType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    548, 6)))

CedentePrestatoreType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Sede'), IndirizzoType, scope=CedentePrestatoreType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    549, 6)))

CedentePrestatoreType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'StabileOrganizzazione'), IndirizzoType,
                               scope=CedentePrestatoreType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    550, 6)))

CedentePrestatoreType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'IscrizioneREA'), IscrizioneREAType,
                               scope=CedentePrestatoreType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    551, 6)))

CedentePrestatoreType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Contatti'), ContattiType, scope=CedentePrestatoreType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    552, 6)))
...
def _BuildAutomaton_17():
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        CedentePrestatoreType._UseForTag(pyxb.namespace.ExpandedName(None, 'DatiAnagrafici')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 548, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        CedentePrestatoreType._UseForTag(pyxb.namespace.ExpandedName(None, 'Sede')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 549, 6))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(
        CedentePrestatoreType._UseForTag(pyxb.namespace.ExpandedName(None, 'StabileOrganizzazione')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 550, 6))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(
        CedentePrestatoreType._UseForTag(pyxb.namespace.ExpandedName(None, 'IscrizioneREA')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 551, 6))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(
        ...
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 552, 6))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(
        CedentePrestatoreType._UseForTag(pyxb.namespace.ExpandedName(None, 'RiferimentoAmministrazione')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 553, 6))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
DatiAnagraficiCedenteType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'IdFiscaleIVA'), IdFiscaleType,
                               scope=DatiAnagraficiCedenteType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    558, 6)))

DatiAnagraficiCedenteType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'CodiceFiscale'), CodiceFiscaleType,
                               scope=DatiAnagraficiCedenteType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    559, 6)))

DatiAnagraficiCedenteType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Anagrafica'), AnagraficaType,
                               scope=DatiAnagraficiCedenteType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    560, 6)))

DatiAnagraficiCedenteType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'AlboProfessionale'), String60LatinType,
                               scope=DatiAnagraficiCedenteType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    561, 6)))

DatiAnagraficiCedenteType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'ProvinciaAlbo'), ProvinciaType,
                               scope=DatiAnagraficiCedenteType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    562, 6)))

DatiAnagraficiCedenteType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'NumeroIscrizioneAlbo'), String60Type,
                               scope=DatiAnagraficiCedenteType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    563, 6)))

DatiAnagraficiCedenteType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DataIscrizioneAlbo'), pyxb.binding.datatypes.date,
                               scope=DatiAnagraficiCedenteType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    564, 6)))

DatiAnagraficiCedenteType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'RegimeFiscale'), RegimeFiscaleType,
                               scope=DatiAnagraficiCedenteType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    565, 6)))
...
def _BuildAutomaton_18():
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiAnagraficiCedenteType._UseForTag(pyxb.namespace.ExpandedName(None, 'IdFiscaleIVA')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 558, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiAnagraficiCedenteType._UseForTag(pyxb.namespace.ExpandedName(None, 'CodiceFiscale')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 559, 6))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiAnagraficiCedenteType._UseForTag(pyxb.namespace.ExpandedName(None, 'Anagrafica')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 560, 6))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiAnagraficiCedenteType._UseForTag(pyxb.namespace.ExpandedName(None, 'AlboProfessionale')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 561, 6))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiAnagraficiCedenteType._UseForTag(pyxb.namespace.ExpandedName(None, 'ProvinciaAlbo')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 562, 6))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiAnagraficiCedenteType._UseForTag(pyxb.namespace.ExpandedName(None, 'NumeroIscrizioneAlbo')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 563, 6))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiAnagraficiCedenteType._UseForTag(pyxb.namespace.ExpandedName(None, 'DataIscrizioneAlbo')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 564, 6))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        DatiAnagraficiCedenteType._UseForTag(pyxb.namespace.ExpandedName(None, 'RegimeFiscale')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 565, 6))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
AnagraficaType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Denominazione'), String80LatinType,
                               scope=AnagraficaType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    670, 10)))

AnagraficaType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Nome'), String60LatinType, scope=AnagraficaType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    673, 10)))

AnagraficaType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Cognome'), String60LatinType, scope=AnagraficaType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    674, 10)))

AnagraficaType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Titolo'), TitoloType, scope=AnagraficaType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    677, 6)))

AnagraficaType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'CodEORI'), CodEORIType, scope=AnagraficaType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    678, 6)))
...
def _BuildAutomaton_19():
    ...
    symbol = pyxb.binding.content.ElementUse(
        ...
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 670, 10))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(AnagraficaType._UseForTag(pyxb.namespace.ExpandedName(None, 'Nome')),
                                             pyxb.utils.utility.Location(
                                                 '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 673, 10))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(AnagraficaType._UseForTag(pyxb.namespace.ExpandedName(None, 'Cognome')),
                                             pyxb.utils.utility.Location(
                                                 '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 674, 10))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(AnagraficaType._UseForTag(pyxb.namespace.ExpandedName(None, 'Titolo')),
                                             pyxb.utils.utility.Location(
                                                 '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 677, 6))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(AnagraficaType._UseForTag(pyxb.namespace.ExpandedName(None, 'CodEORI')),
                                             pyxb.utils.utility.Location(
                                                 '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 678, 6))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
...
DatiAnagraficiVettoreType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'NumeroLicenzaGuida'), String20Type,
                               scope=DatiAnagraficiVettoreType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    686, 6)))
...
def _BuildAutomaton_20():
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiAnagraficiVettoreType._UseForTag(pyxb.namespace.ExpandedName(None, 'IdFiscaleIVA')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 683, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiAnagraficiVettoreType._UseForTag(pyxb.namespace.ExpandedName(None, 'CodiceFiscale')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 684, 6))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        DatiAnagraficiVettoreType._UseForTag(pyxb.namespace.ExpandedName(None, 'Anagrafica')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 685, 6))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiAnagraficiVettoreType._UseForTag(pyxb.namespace.ExpandedName(None, 'NumeroLicenzaGuida')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 686, 6))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    transitions = []
...
IscrizioneREAType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Ufficio'), ProvinciaType, scope=IscrizioneREAType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    691, 6)))

IscrizioneREAType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'NumeroREA'), String20Type, scope=IscrizioneREAType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    692, 6)))

IscrizioneREAType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'CapitaleSociale'), Amount2DecimalType,
                               scope=IscrizioneREAType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    693, 6)))

IscrizioneREAType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'SocioUnico'), SocioUnicoType, scope=IscrizioneREAType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    694, 6)))

IscrizioneREAType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'StatoLiquidazione'), StatoLiquidazioneType,
                               scope=IscrizioneREAType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    695, 6)))
...
def _BuildAutomaton_21():
    ...
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(IscrizioneREAType._UseForTag(pyxb.namespace.ExpandedName(None, 'Ufficio')),
                                             pyxb.utils.utility.Location(
                                                 '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 691, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    ...
    symbol = pyxb.binding.content.ElementUse(
        ...
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 692, 6))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        IscrizioneREAType._UseForTag(pyxb.namespace.ExpandedName(None, 'CapitaleSociale')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 693, 6))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        IscrizioneREAType._UseForTag(pyxb.namespace.ExpandedName(None, 'SocioUnico')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 694, 6))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        IscrizioneREAType._UseForTag(pyxb.namespace.ExpandedName(None, 'StatoLiquidazione')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 695, 6))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    transitions = []
...
ContattiType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Telefono'), TelFaxType, scope=ContattiType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    700, 6)))

ContattiType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Fax'), TelFaxType, scope=ContattiType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    701, 6)))

ContattiType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Email'), EmailType, scope=ContattiType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    702, 6)))
...
def _BuildAutomaton_22():
    ...
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(ContattiType._UseForTag(pyxb.namespace.ExpandedName(None, 'Telefono')),
                                             pyxb.utils.utility.Location(
                                                 '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 700, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(ContattiType._UseForTag(pyxb.namespace.ExpandedName(None, 'Fax')),
                                             pyxb.utils.utility.Location(
                                                 '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 701, 6))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(ContattiType._UseForTag(pyxb.namespace.ExpandedName(None, 'Email')),
                                             pyxb.utils.utility.Location(
                                                 '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 702, 6))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
...
RappresentanteFiscaleType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DatiAnagrafici'), DatiAnagraficiRappresentanteType,
...
def _BuildAutomaton_23():
    ...
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        RappresentanteFiscaleType._UseForTag(pyxb.namespace.ExpandedName(None, 'DatiAnagrafici')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 710, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    st_0._set_transitionSet(transitions)
...
def _BuildAutomaton_24():
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiAnagraficiRappresentanteType._UseForTag(pyxb.namespace.ExpandedName(None, 'IdFiscaleIVA')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 715, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiAnagraficiRappresentanteType._UseForTag(pyxb.namespace.ExpandedName(None, 'CodiceFiscale')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 716, 6))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        DatiAnagraficiRappresentanteType._UseForTag(pyxb.namespace.ExpandedName(None, 'Anagrafica')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 717, 6))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
CessionarioCommittenteType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DatiAnagrafici'), DatiAnagraficiCessionarioType,
                               scope=CessionarioCommittenteType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    725, 6)))

CessionarioCommittenteType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Sede'), IndirizzoType,
                               scope=CessionarioCommittenteType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    726, 6)))
...
CessionarioCommittenteType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'RappresentanteFiscale'),
                               RappresentanteFiscaleCessionarioType, scope=CessionarioCommittenteType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    728, 6)))
...
def _BuildAutomaton_25():
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        CessionarioCommittenteType._UseForTag(pyxb.namespace.ExpandedName(None, 'DatiAnagrafici')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 725, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        CessionarioCommittenteType._UseForTag(pyxb.namespace.ExpandedName(None, 'Sede')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 726, 6))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(
        CessionarioCommittenteType._UseForTag(pyxb.namespace.ExpandedName(None, 'StabileOrganizzazione')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 727, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(
        CessionarioCommittenteType._UseForTag(pyxb.namespace.ExpandedName(None, 'RappresentanteFiscale')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 728, 6))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
RappresentanteFiscaleCessionarioType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Nome'), String60LatinType,
                               scope=RappresentanteFiscaleCessionarioType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    739, 10)))

RappresentanteFiscaleCessionarioType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Cognome'), String60LatinType,
                               scope=RappresentanteFiscaleCessionarioType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    740, 10)))
...
def _BuildAutomaton_26():
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        RappresentanteFiscaleCessionarioType._UseForTag(pyxb.namespace.ExpandedName(None, 'IdFiscaleIVA')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 733, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        RappresentanteFiscaleCessionarioType._UseForTag(pyxb.namespace.ExpandedName(None, 'Denominazione')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 736, 10))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        RappresentanteFiscaleCessionarioType._UseForTag(pyxb.namespace.ExpandedName(None, 'Nome')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 739, 10))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        RappresentanteFiscaleCessionarioType._UseForTag(pyxb.namespace.ExpandedName(None, 'Cognome')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 740, 10))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
def _BuildAutomaton_27():
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiAnagraficiCessionarioType._UseForTag(pyxb.namespace.ExpandedName(None, 'IdFiscaleIVA')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 747, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiAnagraficiCessionarioType._UseForTag(pyxb.namespace.ExpandedName(None, 'CodiceFiscale')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 748, 6))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        DatiAnagraficiCessionarioType._UseForTag(pyxb.namespace.ExpandedName(None, 'Anagrafica')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 749, 6))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
DatiBeniServiziType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DettaglioLinee'), DettaglioLineeType,
                               scope=DatiBeniServiziType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    757, 6)))

DatiBeniServiziType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DatiRiepilogo'), DatiRiepilogoType,
                               scope=DatiBeniServiziType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    758, 6)))
...
def _BuildAutomaton_28():
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiBeniServiziType._UseForTag(pyxb.namespace.ExpandedName(None, 'DettaglioLinee')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 757, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        DatiBeniServiziType._UseForTag(pyxb.namespace.ExpandedName(None, 'DatiRiepilogo')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 758, 6))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
DatiVeicoliType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'TotalePercorso'), String15Type, scope=DatiVeicoliType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    768, 6)))
...
def _BuildAutomaton_29():
    ...
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(DatiVeicoliType._UseForTag(pyxb.namespace.ExpandedName(None, 'Data')),
                                             pyxb.utils.utility.Location(
                                                 '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 767, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    ...
    symbol = pyxb.binding.content.ElementUse(
        ...
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 768, 6))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
DatiPagamentoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'CondizioniPagamento'), CondizioniPagamentoType,
                               scope=DatiPagamentoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    776, 6)))

DatiPagamentoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DettaglioPagamento'), DettaglioPagamentoType,
                               scope=DatiPagamentoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    777, 6)))
...
def _BuildAutomaton_30():
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiPagamentoType._UseForTag(pyxb.namespace.ExpandedName(None, 'CondizioniPagamento')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 776, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        DatiPagamentoType._UseForTag(pyxb.namespace.ExpandedName(None, 'DettaglioPagamento')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 777, 6))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
...
DettaglioPagamentoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Beneficiario'), String200LatinType,
                               scope=DettaglioPagamentoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    803, 6)))

DettaglioPagamentoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'ModalitaPagamento'), ModalitaPagamentoType,
                               scope=DettaglioPagamentoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    804, 6)))

DettaglioPagamentoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DataRiferimentoTerminiPagamento'),
                               pyxb.binding.datatypes.date, scope=DettaglioPagamentoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    805, 6)))

DettaglioPagamentoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'GiorniTerminiPagamento'), GiorniTerminePagamentoType,
                               scope=DettaglioPagamentoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    806, 6)))

DettaglioPagamentoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DataScadenzaPagamento'), pyxb.binding.datatypes.date,
                               scope=DettaglioPagamentoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    807, 6)))

DettaglioPagamentoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'ImportoPagamento'), Amount2DecimalType,
                               scope=DettaglioPagamentoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    808, 6)))

DettaglioPagamentoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'CodUfficioPostale'), String20Type,
                               scope=DettaglioPagamentoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    809, 6)))

DettaglioPagamentoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'CognomeQuietanzante'), String60LatinType,
                               scope=DettaglioPagamentoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    810, 6)))

DettaglioPagamentoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'NomeQuietanzante'), String60LatinType,
                               scope=DettaglioPagamentoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    811, 6)))

DettaglioPagamentoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'CFQuietanzante'), CodiceFiscalePFType,
                               scope=DettaglioPagamentoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    812, 6)))

DettaglioPagamentoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'TitoloQuietanzante'), TitoloType,
                               scope=DettaglioPagamentoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    813, 6)))

DettaglioPagamentoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'IstitutoFinanziario'), String80LatinType,
                               scope=DettaglioPagamentoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    814, 6)))

DettaglioPagamentoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'IBAN'), IBANType, scope=DettaglioPagamentoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    815, 6)))

DettaglioPagamentoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'ABI'), ABIType, scope=DettaglioPagamentoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    816, 6)))

DettaglioPagamentoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'CAB'), CABType, scope=DettaglioPagamentoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    817, 6)))

DettaglioPagamentoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'BIC'), BICType, scope=DettaglioPagamentoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    818, 6)))

DettaglioPagamentoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'ScontoPagamentoAnticipato'), Amount2DecimalType,
                               scope=DettaglioPagamentoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    819, 6)))

DettaglioPagamentoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DataLimitePagamentoAnticipato'),
                               pyxb.binding.datatypes.date, scope=DettaglioPagamentoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    820, 6)))

DettaglioPagamentoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'PenalitaPagamentiRitardati'), Amount2DecimalType,
                               scope=DettaglioPagamentoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    821, 6)))

DettaglioPagamentoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DataDecorrenzaPenale'), pyxb.binding.datatypes.date,
                               scope=DettaglioPagamentoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    822, 6)))

DettaglioPagamentoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'CodicePagamento'), String60Type,
                               scope=DettaglioPagamentoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    823, 6)))
...
def _BuildAutomaton_31():
    ...
    cc_12 = fac.CounterCondition(min=0, max=1,
                                 metadata=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                      817, 6))
    counters.add(cc_12)
    cc_13 = fac.CounterCondition(min=0, max=1,
                                 metadata=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                      818, 6))
    counters.add(cc_13)
    cc_14 = fac.CounterCondition(min=0, max=1,
                                 metadata=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                      819, 6))
    counters.add(cc_14)
    cc_15 = fac.CounterCondition(min=0, max=1,
                                 metadata=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                      820, 6))
    counters.add(cc_15)
    cc_16 = fac.CounterCondition(min=0, max=1,
                                 metadata=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                      821, 6))
    counters.add(cc_16)
    cc_17 = fac.CounterCondition(min=0, max=1,
                                 metadata=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                      822, 6))
    counters.add(cc_17)
    cc_18 = fac.CounterCondition(min=0, max=1,
                                 metadata=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                      823, 6))
    counters.add(cc_18)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DettaglioPagamentoType._UseForTag(pyxb.namespace.ExpandedName(None, 'Beneficiario')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 803, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DettaglioPagamentoType._UseForTag(pyxb.namespace.ExpandedName(None, 'ModalitaPagamento')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 804, 6))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DettaglioPagamentoType._UseForTag(pyxb.namespace.ExpandedName(None, 'DataRiferimentoTerminiPagamento')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 805, 6))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DettaglioPagamentoType._UseForTag(pyxb.namespace.ExpandedName(None, 'GiorniTerminiPagamento')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 806, 6))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DettaglioPagamentoType._UseForTag(pyxb.namespace.ExpandedName(None, 'DataScadenzaPagamento')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 807, 6))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        DettaglioPagamentoType._UseForTag(pyxb.namespace.ExpandedName(None, 'ImportoPagamento')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 808, 6))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(
        DettaglioPagamentoType._UseForTag(pyxb.namespace.ExpandedName(None, 'CodUfficioPostale')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 809, 6))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(
        DettaglioPagamentoType._UseForTag(pyxb.namespace.ExpandedName(None, 'CognomeQuietanzante')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 810, 6))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(
        DettaglioPagamentoType._UseForTag(pyxb.namespace.ExpandedName(None, 'NomeQuietanzante')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 811, 6))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(
        DettaglioPagamentoType._UseForTag(pyxb.namespace.ExpandedName(None, 'CFQuietanzante')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 812, 6))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_8, False))
    symbol = pyxb.binding.content.ElementUse(
        DettaglioPagamentoType._UseForTag(pyxb.namespace.ExpandedName(None, 'TitoloQuietanzante')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 813, 6))
    st_10 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_9, False))
    symbol = pyxb.binding.content.ElementUse(
        DettaglioPagamentoType._UseForTag(pyxb.namespace.ExpandedName(None, 'IstitutoFinanziario')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 814, 6))
    st_11 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = set()
    ...
    symbol = pyxb.binding.content.ElementUse(
        ...
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 815, 6))
    ...
    symbol = pyxb.binding.content.ElementUse(
        ...
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 816, 6))
    ...
    symbol = pyxb.binding.content.ElementUse(
        ...
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 817, 6))
    ...
    symbol = pyxb.binding.content.ElementUse(
        ...
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 818, 6))
    st_15 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_15)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_14, False))
    symbol = pyxb.binding.content.ElementUse(
        DettaglioPagamentoType._UseForTag(pyxb.namespace.ExpandedName(None, 'ScontoPagamentoAnticipato')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 819, 6))
    st_16 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_16)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_15, False))
    symbol = pyxb.binding.content.ElementUse(
        DettaglioPagamentoType._UseForTag(pyxb.namespace.ExpandedName(None, 'DataLimitePagamentoAnticipato')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 820, 6))
    st_17 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_17)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_16, False))
    symbol = pyxb.binding.content.ElementUse(
        DettaglioPagamentoType._UseForTag(pyxb.namespace.ExpandedName(None, 'PenalitaPagamentiRitardati')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 821, 6))
    st_18 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_18)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_17, False))
    symbol = pyxb.binding.content.ElementUse(
        DettaglioPagamentoType._UseForTag(pyxb.namespace.ExpandedName(None, 'DataDecorrenzaPenale')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 822, 6))
    ...
    symbol = pyxb.binding.content.ElementUse(
        DettaglioPagamentoType._UseForTag(pyxb.namespace.ExpandedName(None, 'CodicePagamento')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 823, 6))
...
TerzoIntermediarioSoggettoEmittenteType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DatiAnagrafici'),
                               DatiAnagraficiTerzoIntermediarioType, scope=TerzoIntermediarioSoggettoEmittenteType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    961, 6)))
...
def _BuildAutomaton_32():
    ...
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        TerzoIntermediarioSoggettoEmittenteType._UseForTag(pyxb.namespace.ExpandedName(None, 'DatiAnagrafici')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 961, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    st_0._set_transitionSet(transitions)
...
def _BuildAutomaton_33():
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiAnagraficiTerzoIntermediarioType._UseForTag(pyxb.namespace.ExpandedName(None, 'IdFiscaleIVA')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 966, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiAnagraficiTerzoIntermediarioType._UseForTag(pyxb.namespace.ExpandedName(None, 'CodiceFiscale')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 967, 6))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        DatiAnagraficiTerzoIntermediarioType._UseForTag(pyxb.namespace.ExpandedName(None, 'Anagrafica')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 968, 6))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
AllegatiType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'NomeAttachment'), String60LatinType,
                               scope=AllegatiType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    976, 6)))

AllegatiType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'AlgoritmoCompressione'), String10Type,
                               scope=AllegatiType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    977, 6)))

AllegatiType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'FormatoAttachment'), String10Type, scope=AllegatiType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    978, 6)))

AllegatiType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DescrizioneAttachment'), String100LatinType,
                               scope=AllegatiType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    979, 6)))

AllegatiType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Attachment'), pyxb.binding.datatypes.base64Binary,
                               scope=AllegatiType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    980, 6)))
...
def _BuildAutomaton_34():
    ...
    symbol = pyxb.binding.content.ElementUse(
        ...
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 976, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        AllegatiType._UseForTag(pyxb.namespace.ExpandedName(None, 'AlgoritmoCompressione')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 977, 6))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        AllegatiType._UseForTag(pyxb.namespace.ExpandedName(None, 'DescrizioneAttachment')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 979, 6))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(AllegatiType._UseForTag(pyxb.namespace.ExpandedName(None, 'Attachment')),
                                             pyxb.utils.utility.Location(
                                                 '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 980, 6))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
...
DettaglioLineeType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'NumeroLinea'), NumeroLineaType,
                               scope=DettaglioLineeType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    985, 6)))

DettaglioLineeType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'TipoCessionePrestazione'),
                                                          TipoCessionePrestazioneType, scope=DettaglioLineeType,
                                                          location=pyxb.utils.utility.Location(
                                                              '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 986,
                                                              6)))

DettaglioLineeType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'CodiceArticolo'), CodiceArticoloType,
                               scope=DettaglioLineeType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    987, 6)))

DettaglioLineeType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Descrizione'), String1000LatinType,
                               scope=DettaglioLineeType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    988, 6)))

DettaglioLineeType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Quantita'), QuantitaType, scope=DettaglioLineeType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    989, 6)))

DettaglioLineeType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'UnitaMisura'), String10Type, scope=DettaglioLineeType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    990, 6)))

DettaglioLineeType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DataInizioPeriodo'), pyxb.binding.datatypes.date,
                               scope=DettaglioLineeType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    991, 6)))

DettaglioLineeType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DataFinePeriodo'), pyxb.binding.datatypes.date,
                               scope=DettaglioLineeType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    992, 6)))

DettaglioLineeType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'PrezzoUnitario'), Amount8DecimalType,
                               scope=DettaglioLineeType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    993, 6)))
...
DettaglioLineeType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'PrezzoTotale'), Amount8DecimalType,
                               scope=DettaglioLineeType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    995, 6)))

DettaglioLineeType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'AliquotaIVA'), RateType, scope=DettaglioLineeType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    996, 6)))

DettaglioLineeType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Ritenuta'), RitenutaType, scope=DettaglioLineeType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    997, 6)))

DettaglioLineeType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Natura'), NaturaType, scope=DettaglioLineeType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    998, 6)))
...
DettaglioLineeType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'AltriDatiGestionali'), AltriDatiGestionaliType,
                               scope=DettaglioLineeType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    1000, 6)))
...
def _BuildAutomaton_35():
    ...
    cc_9 = fac.CounterCondition(min=0, max=1,
                                metadata=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                     999, 6))
    counters.add(cc_9)
    cc_10 = fac.CounterCondition(min=0, max=None,
                                 metadata=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                      1000, 6))
    counters.add(cc_10)
    states = []
    ...
    symbol = pyxb.binding.content.ElementUse(
        ...
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 985, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DettaglioLineeType._UseForTag(pyxb.namespace.ExpandedName(None, 'TipoCessionePrestazione')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 986, 6))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DettaglioLineeType._UseForTag(pyxb.namespace.ExpandedName(None, 'CodiceArticolo')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 987, 6))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DettaglioLineeType._UseForTag(pyxb.namespace.ExpandedName(None, 'Descrizione')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 988, 6))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DettaglioLineeType._UseForTag(pyxb.namespace.ExpandedName(None, 'Quantita')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 989, 6))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DettaglioLineeType._UseForTag(pyxb.namespace.ExpandedName(None, 'UnitaMisura')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 990, 6))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DettaglioLineeType._UseForTag(pyxb.namespace.ExpandedName(None, 'DataInizioPeriodo')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 991, 6))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DettaglioLineeType._UseForTag(pyxb.namespace.ExpandedName(None, 'DataFinePeriodo')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 992, 6))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DettaglioLineeType._UseForTag(pyxb.namespace.ExpandedName(None, 'PrezzoUnitario')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 993, 6))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DettaglioLineeType._UseForTag(pyxb.namespace.ExpandedName(None, 'ScontoMaggiorazione')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 994, 6))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DettaglioLineeType._UseForTag(pyxb.namespace.ExpandedName(None, 'PrezzoTotale')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 995, 6))
    st_10 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        DettaglioLineeType._UseForTag(pyxb.namespace.ExpandedName(None, 'AliquotaIVA')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 996, 6))
    st_11 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(
        ...
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 997, 6))
    st_12 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_8, False))
    symbol = pyxb.binding.content.ElementUse(DettaglioLineeType._UseForTag(pyxb.namespace.ExpandedName(None, 'Natura')),
                                             pyxb.utils.utility.Location(
                                                 '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 998, 6))
    st_13 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_13)
    ...
    final_update.add(fac.UpdateInstruction(cc_9, False))
    symbol = pyxb.binding.content.ElementUse(
        DettaglioLineeType._UseForTag(pyxb.namespace.ExpandedName(None, 'RiferimentoAmministrazione')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 999, 6))
    st_14 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_14)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_10, False))
    symbol = pyxb.binding.content.ElementUse(
        DettaglioLineeType._UseForTag(pyxb.namespace.ExpandedName(None, 'AltriDatiGestionali')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1000, 6))
    st_15 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_15)
    transitions = []
...
CodiceArticoloType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'CodiceTipo'), String35Type, scope=CodiceArticoloType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    1005, 6)))

CodiceArticoloType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'CodiceValore'), String35LatinExtType,
...
def _BuildAutomaton_36():
    ...
    symbol = pyxb.binding.content.ElementUse(
        ...
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1005, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        CodiceArticoloType._UseForTag(pyxb.namespace.ExpandedName(None, 'CodiceValore')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1006, 6))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
AltriDatiGestionaliType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'TipoDato'), String10Type,
                               scope=AltriDatiGestionaliType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    1011, 6)))

AltriDatiGestionaliType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'RiferimentoTesto'), String60LatinType,
                               scope=AltriDatiGestionaliType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    1012, 6)))

AltriDatiGestionaliType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'RiferimentoNumero'), Amount8DecimalType,
                               scope=AltriDatiGestionaliType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    1013, 6)))

AltriDatiGestionaliType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'RiferimentoData'), pyxb.binding.datatypes.date,
                               scope=AltriDatiGestionaliType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    1014, 6)))
...
def _BuildAutomaton_37():
    ...
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        AltriDatiGestionaliType._UseForTag(pyxb.namespace.ExpandedName(None, 'TipoDato')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1011, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(
        AltriDatiGestionaliType._UseForTag(pyxb.namespace.ExpandedName(None, 'RiferimentoTesto')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1012, 6))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(
        AltriDatiGestionaliType._UseForTag(pyxb.namespace.ExpandedName(None, 'RiferimentoNumero')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1013, 6))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(
        AltriDatiGestionaliType._UseForTag(pyxb.namespace.ExpandedName(None, 'RiferimentoData')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1014, 6))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
DatiRiepilogoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'AliquotaIVA'), RateType, scope=DatiRiepilogoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    1029, 6)))

DatiRiepilogoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Natura'), NaturaType, scope=DatiRiepilogoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    1030, 6)))

DatiRiepilogoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'SpeseAccessorie'), Amount2DecimalType,
                               scope=DatiRiepilogoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    1031, 6)))

DatiRiepilogoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Arrotondamento'), Amount8DecimalType,
                               scope=DatiRiepilogoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    1032, 6)))

DatiRiepilogoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'ImponibileImporto'), Amount2DecimalType,
                               scope=DatiRiepilogoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    1033, 6)))

DatiRiepilogoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Imposta'), Amount2DecimalType,
                               scope=DatiRiepilogoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    1034, 6)))

DatiRiepilogoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'EsigibilitaIVA'), EsigibilitaIVAType,
                               scope=DatiRiepilogoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    1035, 6)))

DatiRiepilogoType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'RiferimentoNormativo'), String100LatinType,
                               scope=DatiRiepilogoType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    1036, 6)))
...
def _BuildAutomaton_38():
    ...
    symbol = pyxb.binding.content.ElementUse(
        ...
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1029, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(DatiRiepilogoType._UseForTag(pyxb.namespace.ExpandedName(None, 'Natura')),
                                             pyxb.utils.utility.Location(
                                                 '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1030, 6))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiRiepilogoType._UseForTag(pyxb.namespace.ExpandedName(None, 'SpeseAccessorie')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1031, 6))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiRiepilogoType._UseForTag(pyxb.namespace.ExpandedName(None, 'Arrotondamento')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1032, 6))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiRiepilogoType._UseForTag(pyxb.namespace.ExpandedName(None, 'ImponibileImporto')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1033, 6))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(DatiRiepilogoType._UseForTag(pyxb.namespace.ExpandedName(None, 'Imposta')),
                                             pyxb.utils.utility.Location(
                                                 '../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1034, 6))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    ...
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiRiepilogoType._UseForTag(pyxb.namespace.ExpandedName(None, 'EsigibilitaIVA')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1035, 6))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiRiepilogoType._UseForTag(pyxb.namespace.ExpandedName(None, 'RiferimentoNormativo')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 1036, 6))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    transitions = []
...
FatturaElettronicaType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'FatturaElettronicaHeader'),
                               FatturaElettronicaHeaderType, scope=FatturaElettronicaType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    18, 6)))

FatturaElettronicaType._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'FatturaElettronicaBody'), FatturaElettronicaBodyType,
                               scope=FatturaElettronicaType,
                               location=pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd',
                                                                    19, 6)))

FatturaElettronicaType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(_Namespace_ds, 'Signature'),
...
def _BuildAutomaton_39():
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        FatturaElettronicaType._UseForTag(pyxb.namespace.ExpandedName(None, 'FatturaElettronicaHeader')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 18, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        FatturaElettronicaType._UseForTag(pyxb.namespace.ExpandedName(None, 'FatturaElettronicaBody')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 19, 6))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(
        FatturaElettronicaType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_ds, 'Signature')),
        pyxb.utils.utility.Location('../data/fatturapa/FatturaPA_versione_1.2.1.xsd', 20, 6))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    transitions = []
    transitions.append(fac.Transition(st_1, [
