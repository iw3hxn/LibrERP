                    ...
                    %for line in inv.inventory_line_loc_id:
                        ...
                        <tr>
                            ...
                            %if line.product_id.is_kit:
                                <td style="text-align:right;white-space:nowrap">${formatLang(line.product_id.cost_price)}</td>
                                <td style="text-align:right;white-space:nowrap">${formatLang(line.product_qty*line.product_id.cost_price)}</td>
                                <td style="text-align:right;white-space:nowrap">${formatLang(line.product_qty_calc*line.product_id.cost_price)}</td>
                            % else:
