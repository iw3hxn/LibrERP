        ...
        for make in self.browse(cr, uid, ids, context=context):
            ...
            for case in case_obj.browse(cr, uid, data, context=context):
                ...
                vals = {
                    ...
                    'partner_order_id': make.partner_address_id and make.partner_address_id.id or case.partner_address_id,
                    'partner_shipping_id': make.partner_address_id and make.partner_address_id.id or partner_addr['delivery'],
