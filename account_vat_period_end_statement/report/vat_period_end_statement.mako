...
<table class="tax_codes"  width="100%" >
    ...
    <tr >
        ...
        <td style="text-align:right">${  formatLang(statement.payable_vat_amount + statement.previous_debit_vat_amount) | entity}</td>
        <td style="text-align:right">${  formatLang(statement.deductible_vat_amount + statement.previous_credit_vat_amount) | entity }</td>
    </tr>
    <tr >
